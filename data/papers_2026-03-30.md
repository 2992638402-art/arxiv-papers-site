...
**arXiv ID:** [2603.26666v1](https://arxiv.org/abs/2603.26666v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2603.26666v1.pdf)

---

## 2. Meta-Adaptive Beam Search Planning for Transformer-Based Reinforcement Learning Control of UAVs with Overhead Manipulators under Flight Disturbances

**arXiv ID:** [2603.26612v1](https://arxiv.org/abs/2603.26612v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2603.26322v1.pdf)

---

## 5. Line-of-Sight-Constrained Multi-Robot Mapless Navigation via Polygonal Visible Regions

**arXiv ID:** [2603.26314v1](https://arxiv.org/abs/2603.26314v1)

**作者:** Ruofei Bai, Shenghai Yuan, Xinhang Xu, Xingyu Ji, Xiaowei Li et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2603.26314v1.pdf)

---

## 6. DFM-VLA: Iterative Action Refinement for Robot Manipulation via Discrete Flow Matching

**arXiv ID:** [2603.26320v1](https://arxiv.org/abs/2603.26320v1)

**作者:** Jiayi Chen, Wenxuan Song, Shuai Chen, Jingbo Wang, Zhijun Li et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2603.26320v1.pdf)

---

## 7. Can Vision Foundation Models Navigate? Zero-Shot Real-World Evaluation and Lessons Learned

**arXiv ID:** [2603.25937v1](https://arxiv.org/abs/2603.25937v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2603.25937v1.pdf)

---

## 8. User Involvement in Robotic Wheelchair Development: A Decade of Limited Progress

**arXiv ID:** [2603.26543v1](https://arxiv.org/abs/2603.26543v1)

**作者:** Mario Andres Chavarria, Santiago Price Torrendell, Aude Billard, Samia Hurst, Sébastien Kessler et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2603.26543v1.pdf)

---

## 9. DRUM: Diffusion-based Raydrop-aware Unpaired Mapping for Sim2Real LiDAR Segmentation

**arXiv ID:** [2603.26263v1](https://arxiv.org/abs/2603.26263v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2603.26263v1.pdf)

---

## 10. 120 Minutes and a Laptop: Minimalist Image-goal Navigation via Unsupervised Exploration and Offline RL

**arXiv ID:** [2603.26441v1](https://arxiv.org/abs/2603.26441v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2603.26441v1.pdf)

---

## 11. Ruka-v2: Tendon Driven Open-Source Dexterous Hand with Wrist and Abduction for Robot Learning

**arXiv ID:** [2603.26660v1](https://arxiv.org/abs/2603.26660v1)

**作者:** Xinqi, Liu, Ruoxi Hu, Alejandro Ojeda Olarte, Zhuoran Chen et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2603.26660v1.pdf)

---

## 12. Adapt as You Say: Online Interactive Bimanual Skill Adaptation via Human Language Feedback

**arXiv ID:** [2603.26466v1](https://arxiv.org/abs/2603.26466v1)

**作者:** Zhuo Li, Dianxi Li, Tao Teng, Quentin Rouxel, Zhipeng Dong et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2603.26466v1.pdf)

---

## 13. Curvature-aware Expected Free Energy as an Acquisition Function for Bayesian Optimization

**arXiv ID:** [2603.26339v1](https://arxiv.org/abs/2603.26339v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2603.26339v1.pdf)

---

## 14. Drive-Through 3D Vehicle Exterior Reconstruction via Dynamic-Scene SfM and Distortion-Aware Gaussian Splatting

**arXiv ID:** [2603.26638v1](https://arxiv.org/abs/2603.26638v1)

**作者:** Nitin Kulkarni, Akhil Devarashetti, Charlie Cluss, Livio Forte, Philip Schneider et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2603.26638v1.pdf)

---

## 15. SwarmCoDe: A Scalable Co-Design Framework for Heterogeneous Robot Swarms via Dynamic Speciation
...
## 16. Policy-Guided World Model Planning for Language-Conditioned Visual Navigation

**arXiv ID:** [2603.25981v1](https://arxiv.org/abs/2603.25981v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2603.25981v1.pdf)

---

## 17. Realtime-VLA V2: Learning to Run VLAs Fast, Smooth, and Accurate

**arXiv ID:** [2603.26360v1](https://arxiv.org/abs/2603.26360v1)

**作者:** Chen Yang, Yucheng Hu, Yunchao Ma, Yunhuan Yang, Jing Tan et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2603.26360v1.pdf)

---

## 18. The Multi-AMR Buffer Storage, Retrieval, and Reshuffling Problem: Exact and Heuristic Approaches

**arXiv ID:** [2603.26542v1](https://arxiv.org/abs/2603.26542v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2603.26542v1.pdf)

---

## 19. Partial Motion Imitation for Learning Cart Pushing with Legged Manipulators

**arXiv ID:** [2603.26659v1](https://arxiv.org/abs/2603.26659v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2603.26659v1.pdf)

---

## 20. T-800: An 800 Hz Data Glove for Precise Hand Gesture Tracking

**arXiv ID:** [2603.26403v1](https://arxiv.org/abs/2603.26403v1)

**作者:** Haoyang Luo, Zihang Zhao, Leiyao Cui, Saiyao Zhang, Liu Yang et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2603.26403v1.pdf)

---

## 21. Addressing Ambiguity in Imitation Learning through Product of Experts based Negative Feedback

**arXiv ID:** [2603.26467v1](https://arxiv.org/abs/2603.26467v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2603.26467v1.pdf)

---

## 22. DTP-Attack: A decision-based black-box adversarial attack on trajectory prediction

**arXiv ID:** [2603.26462v1](https://arxiv.org/abs/2603.26462v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2603.26462v1.pdf)

---

## 23. Optimal Prioritized Dissipation and Closed-Form Damping Limitation under Actuator Constraints for Haptic Interfaces

**arXiv ID:** [2603.26347v1](https://arxiv.org/abs/2603.26347v1)

**作者:** Camilla Celli, Andrea Bini, Valerio Novelli, Alessandro Filippeschi, Francesco Porcini et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2603.26347v1.pdf)

---

## 24. GeoReFormer: Geometry-Aware Refinement for Lane Segment Detection and Topology Reasoning

**arXiv ID:** [2603.26018v1](https://arxiv.org/abs/2603.26018v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2603.26018v1.pdf)

---

## 25. 4DRaL: Bridging 4D Radar with LiDAR for Place Recognition using Knowledge Distillation

**arXiv ID:** [2603.26206v1](https://arxiv.org/abs/2603.26206v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2603.26206v1.pdf)
