...
**PDF:** [下载](http://arxiv.org/pdf/2604.16279v1.pdf)

---

## 2. AtManRL: Towards Faithful Reasoning via Differentiable Attention Saliency

**arXiv ID:** [2604.16158v1](https://arxiv.org/abs/2604.16158v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2604.16158v1.pdf)

---

## 3. Sketching the Readout of Large Language Models for Scalable Data Attribution and Valuation

**arXiv ID:** [2604.16197v1](https://arxiv.org/abs/2604.16197v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2604.16197v1.pdf)

---

## 4. JumpLoRA: Sparse Adapters for Continual Learning in Large Language Models

**arXiv ID:** [2604.16171v1](https://arxiv.org/abs/2604.16171v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2604.16171v1.pdf)

---

## 5. Information Router for Mitigating Modality Dominance in Vision-Language Models

**arXiv ID:** [2604.16264v1](https://arxiv.org/abs/2604.16264v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2604.16264v1.pdf)

---

## 6. Learning to Reason with Insight for Informal Theorem Proving

**arXiv ID:** [2604.16278v1](https://arxiv.org/abs/2604.16278v1)

**作者:** Yunhe Li, Hao Shi, Bowen Deng, Wei Wang, Mengzhe Ruan et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2604.16278v1.pdf)

---

## 7. Synthetic data in cryptocurrencies using generative models

**arXiv ID:** [2604.16182v1](https://arxiv.org/abs/2604.16182v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2604.16182v1.pdf)

---

## 8. Adaptive multi-fidelity optimization with fast learning rates

**arXiv ID:** [2604.16239v1](https://arxiv.org/abs/2604.16239v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2604.16239v1.pdf)

---

## 9. Geometric regularization of autoencoders via observed stochastic dynamics

**arXiv ID:** [2604.16282v1](https://arxiv.org/abs/2604.16282v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2604.16282v1.pdf)

---

## 10. Detecting and Suppressing Reward Hacking with Gradient Fingerprints

**arXiv ID:** [2604.16242v1](https://arxiv.org/abs/2604.16242v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2604.16242v1.pdf)

---

## 11. Enhancing AI and Dynamical Subseasonal Forecasts with Probabilistic Bias Correction

**arXiv ID:** [2604.16238v1](https://arxiv.org/abs/2604.16238v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2604.16238v1.pdf)

---

## 12. Tabular foundation models for in-context prediction of molecular properties

**arXiv ID:** [2604.16123v1](https://arxiv.org/abs/2604.16123v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2604.16123v1.pdf)

---

## 13. Beyond Distribution Sharpening: The Importance of Task Rewards

**arXiv ID:** [2604.16259v1](https://arxiv.org/abs/2604.16259v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2604.16259v1.pdf)

---

## 14. SCRIPT: Implementing an Intelligent Tutoring System for Programming in a German University Context

**arXiv ID:** [2604.16117v1](https://arxiv.org/abs/2604.16117v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2604.16117v1.pdf)

---

## 15. Unveiling Stochasticity: Universal Multi-modal Probabilistic Modeling for Traffic Forecasting

**arXiv ID:** [2604.16084v1](https://arxiv.org/abs/2604.16084v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2604.16084v1.pdf)

---

## 16. Sentiment Analysis of German Sign Language Fairy Tales

**arXiv ID:** [2604.16138v1](https://arxiv.org/abs/2604.16138v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2604.16138v1.pdf)

---

## 17. Univariate Channel Fusion for Multivariate Time Series Classification

**arXiv ID:** [2604.16119v1](https://arxiv.org/abs/2604.16119v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2604.16119v1.pdf)

---

## 18. Training Time Prediction for Mixed Precision-based Distributed Training

**arXiv ID:** [2604.16145v1](https://arxiv.org/abs/2604.16145v1)

**作者:** Minchul Kang, Changyong Shin, Jinwoo Jeong, Hyunho Lee, Younghun Go et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2604.16145v1.pdf)

---

## 19. Joint-Centric Dual Contrastive Alignment with Structure-Preserving and Information-Balanced Regularization

**arXiv ID:** [2604.16247v1](https://arxiv.org/abs/2604.16247v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2604.16247v1.pdf)

---

## 20. OT on the Map: Quantifying Domain Shifts in Geographic Space

**arXiv ID:** [2604.16220v1](https://arxiv.org/abs/2604.16220v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2604.16220v1.pdf)

---

## 21. The Harder Path: Last Iterate Convergence for Uncoupled Learning in Zero-Sum Games with Bandit Feedback

**arXiv ID:** [2604.16087v1](https://arxiv.org/abs/2604.16087v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2604.16087v1.pdf)

---

## 22. Stylistic-STORM (ST-STORM) : Perceiving the Semantic Nature of Appearance

**arXiv ID:** [2604.16086v1](https://arxiv.org/abs/2604.16086v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2604.16086v1.pdf)

---

## 23. FL-MHSM: Spatially-adaptive Fusion and Ensemble Learning for Flood-Landslide Multi-Hazard Susceptibility Mapping at Regional Scale

**arXiv ID:** [2604.16265v1](https://arxiv.org/abs/2604.16265v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2604.16265v1.pdf)

---

## 24. Sample Complexity Bounds for Stochastic Shortest Path with a Generative Model

**arXiv ID:** [2604.16111v1](https://arxiv.org/abs/2604.16111v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2604.16111v1.pdf)

---

## 25. Neuro-Symbolic ODE Discovery with Latent Grammar Flow
...
**PDF:** [下载](http://arxiv.org/pdf/2604.16232v1.pdf)
