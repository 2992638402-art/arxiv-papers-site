# arXiv 每日精选 - 2026-05-07

> 今日为您精选 150 篇高质量 AI/ML 论文

## 1. Uncertainty-Aware Exploratory Direct Preference Optimization for Multimodal Large Language Models
...
**PDF:** [下载](http://arxiv.org/pdf/2605.04874v1.pdf)

---

## 2. Computer-Aided Design Generation by Cascaded Discrete Diffusion Model

**arXiv ID:** [2605.05031v1](https://arxiv.org/abs/2605.05031v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.05031v1.pdf)
...
**作者:** Sebastian Wind, Tri-Thien Nguyen, Jeta Sopa, Mahshad Lotfinia, Sebastian Bickelhaup et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.04039v1.pdf)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.03953v1.pdf)

---

## 5. On Adaptivity in Zeroth-Order Optimization

**arXiv ID:** [2605.03869v1](https://arxiv.org/abs/2605.03869v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.03869v1.pdf)

---

## 6. Reinforcement Learning for Compositional Generalization with Outcome-Level Optimization

**arXiv ID:** [2605.04920v1](https://arxiv.org/abs/2605.04920v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.04920v1.pdf)

---

## 7. ReflectDrive-2: Reinforcement-Learning-Aligned Self-Editing for Discrete Diffusion Driving

**arXiv ID:** [2605.04647v1](https://arxiv.org/abs/2605.04647v1)

**作者:** Huimin Wang, Yue Wang, Bihao Cui, Pengxiang Li, Ben Lu et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.04647v1.pdf)

---

## 8. FINER-SQL: Boosting Small Language Models for Text-to-SQL

**arXiv ID:** [2605.03465v1](https://arxiv.org/abs/2605.03465v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.03465v1.pdf)

---

## 9. Memory-Efficient Continual Learning with CLIP Models

**arXiv ID:** [2605.03866v1](https://arxiv.org/abs/2605.03866v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.03866v1.pdf)

---

## 10. Hypergraph Generation via Structured Stochastic Diffusion

**arXiv ID:** [2605.05024v1](https://arxiv.org/abs/2605.05024v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.05024v1.pdf)

---

## 11. Conditional Flow-VAE for Safety-Critical Traffic Scenario Generation

**arXiv ID:** [2605.04366v1](https://arxiv.org/abs/2605.04366v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.04366v1.pdf)

---

## 12. SoK: Robustness in Large Language Models against Jailbreak Attacks

**arXiv ID:** [2605.05058v1](https://arxiv.org/abs/2605.05058v1)

**作者:** Feiyue Xu, Hongsheng Hu, Chaoxiang He, Sheng Hang, Hanqing Hu et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.04960v1.pdf)

---

## 14. Conditional Diffusion Sampling

**arXiv ID:** [2605.04013v1](https://arxiv.org/abs/2605.04013v1)

**作者:** Francisco M. Castro-Macías, Pablo Morales-Álvarez, Saifuddin Syed, Daniel Hernández-Lobato, Rafael Molina et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.04013v1.pdf)

---

## 15. Rethinking Local Learning: A Cheaper and Faster Recipe for LLM Post-Training

**arXiv ID:** [2605.04913v1](https://arxiv.org/abs/2605.04913v1)

**作者:** Hengyu Shi, Tianyang Han, Peizhe Wang, Zhiling Wang, Xu Yang et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.04913v1.pdf)

---

## 16. BenCSSmark: Making the Social Sciences Count in LLM Research

**arXiv ID:** [2605.04886v1](https://arxiv.org/abs/2605.04886v1)

**作者:** Arnault Chatelain, Étienne Ollion, Qianwen Guan, Diandra Fabre, Lorraine Goeuriot et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.04886v1.pdf)

---

## 17. HDFlow: Hierarchical Diffusion-Flow Planning for Long-horizon Tasks

**arXiv ID:** [2605.04525v1](https://arxiv.org/abs/2605.04525v1)

**作者:** Nandiraju Gireesh, Yuanliang Ju, Chaoyi Xu, Weiheng Liu, Yuxuan Wan et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.04525v1.pdf)

---

## 18. UFAL-CUNI at SemEval-2026 Task 11: An Efficient Modular Neuro-symbolic Method for Syllogistic Reasoning

**arXiv ID:** [2605.04941v1](https://arxiv.org/abs/2605.04941v1)

**作者:** Ivan Kartáč, Kristýna Onderková, Jan Bronec, Zdeněk Kasner, Mateusz Lango et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.04941v1.pdf)

---

## 19. Delta-Based Neural Architecture Search: LLM Fine-Tuning via Code Diffs

**arXiv ID:** [2605.04903v1](https://arxiv.org/abs/2605.04903v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.04903v1.pdf)

---

## 20. Explaining and Preventing Alignment Collapse in Iterative RLHF

**arXiv ID:** [2605.04266v1](https://arxiv.org/abs/2605.04266v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.05092v1.pdf)

---

## 22. Local Intrinsic Dimension Unveils Hallucinations in Diffusion Models

**arXiv ID:** [2605.05026v1](https://arxiv.org/abs/2605.05026v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.05026v1.pdf)

---

## 23. The Pinocchio Dimension: Phenomenality of Experience as the Primary Axis of LLM Psychometric Differences

**arXiv ID:** [2605.05080v1](https://arxiv.org/abs/2605.05080v1)

**作者:** Hubert Plisiecki, Sabina Siudaj, Kacper Dudzic, Anna Sterna, Maciej Gorski et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.05080v1.pdf)

---

## 24. Gaze4HRI: Zero-shot Benchmarking Gaze Estimation Neural-Networks for Human-Robot Interaction

**arXiv ID:** [2605.04770v1](https://arxiv.org/abs/2605.04770v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.04770v1.pdf)

---

## 25. Autonomous Laparoscope Control through Unified Mechanics-Based Representation of Multimodal Intraoperative Information

**arXiv ID:** [2605.04408v1](https://arxiv.org/abs/2605.04408v1)

**作者:** Xiaojian Li, Jin Fang, Yudong Shi, Xilin Xiao, Kai Yan et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.04408v1.pdf)

---

## 26. Learning to Act and Cooperate for Distributed Black-Box Consensus Optimization
...
## 27. Bridging Perception and Action: A Lightweight Multimodal Meta-Planner Framework for Robust Earth Observation Agents

**arXiv ID:** [2605.04777v1](https://arxiv.org/abs/2605.04777v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.04777v1.pdf)

---

## 28. Enwar 3.0: An Agentic Multi-Modal LLM Orchestrator for Situation-Aware Beamforming, Blockage Prediction, and Handover Management

**arXiv ID:** [2605.03215v1](https://arxiv.org/abs/2605.03215v1)

**作者:** Ahmad M. Nazar, Abdulkadir Celik, Asmaa Abdallah, Mohamed Y. Selim, Daji Qiao et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.03215v1.pdf)

---

## 29. Federated Learning for Early Prediction of EV Charging Demand

**arXiv ID:** [2605.04993v1](https://arxiv.org/abs/2605.04993v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.04993v1.pdf)

---

## 30. Anticipating Innovation Using Large Language Models

**arXiv ID:** [2605.04875v1](https://arxiv.org/abs/2605.04875v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.04875v1.pdf)

---

## 31. FairEnc: A Fair Vision-Language Model with Fair Vision and Text Encoders for Glaucoma Detection

**arXiv ID:** [2605.04882v1](https://arxiv.org/abs/2605.04882v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.04882v1.pdf)

---

## 32. HERCULES: Hardware-Efficient, Robust, Continual Learning Neural Architecture Search

**arXiv ID:** [2605.04103v1](https://arxiv.org/abs/2605.04103v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.04103v1.pdf)

---

## 33. When Relations Break: Analyzing Relation Hallucination in Vision-Language Model Under Rotation and Noise

**arXiv ID:** [2605.05045v1](https://arxiv.org/abs/2605.05045v1)

**作者:** Philip Wootaek Shin, Ajay Narayanan Sridhar, Sivani Devarapalli, Rui Zhang, Jack Sampson et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.05045v1.pdf)

---

## 34. Adapting Large Language Models to a Low-Resource Agglutinative Language: A Comparative Study of LoRA and QLoRA for Bashkir
...
**PDF:** [下载](http://arxiv.org/pdf/2605.04948v1.pdf)

---

## 35. Optimal Uncertainty-Aware Calibration for the AX=YB Problem

**arXiv ID:** [2605.04809v1](https://arxiv.org/abs/2605.04809v1)

**作者:** Yanjia Chen, Xiangfei Li, Huan Zhao, Yiyuan Hong, Guanxiao Xia et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.04809v1.pdf)

---

## 36. Dr-PoGO: Direct Radar Pose-Graph Optimization

**arXiv ID:** [2605.04806v1](https://arxiv.org/abs/2605.04806v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.04806v1.pdf)

---

## 37. 3D Printing of Passively Actuated Self-Folding Robots with Integrated Functional Modules

**arXiv ID:** [2605.04757v1](https://arxiv.org/abs/2605.04757v1)

**作者:** Gaolin Ge, Qifeng Yang, Haoran Lu, Tingyu Cheng, Martin Nisser et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.04757v1.pdf)

---

## 38. From Pixels to Tokens: A Systematic Study of Latent Action Supervision for Vision-Language-Action Models

**arXiv ID:** [2605.04678v1](https://arxiv.org/abs/2605.04678v1)

**作者:** Yihan Lin, Haoyang Li, Yang Li, Haitao Shen, Yihan Zhao et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.04678v1.pdf)

---

## 39. CRAFT: Counterfactual-to-Interactive Reinforcement Fine-Tuning for Driving Policies

**arXiv ID:** [2605.04470v1](https://arxiv.org/abs/2605.04470v1)

**作者:** Keyu Chen, Nanfei Ye, Yida Wang, Wenchao Sun, Danqi Zhao et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.04470v1.pdf)

---

## 40. Tree-based Credit Assignment for Multi-Agent Memory System

**arXiv ID:** [2605.04811v1](https://arxiv.org/abs/2605.04811v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.04811v1.pdf)

---

## 41. QKVShare: Quantized KV-Cache Handoff for Multi-Agent On-Device LLMs

**arXiv ID:** [2605.03884v1](https://arxiv.org/abs/2605.03884v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.03884v1.pdf)

---

## 42. SOTOPIA-TOM: Evaluating Information Management in Multi-Agent Interaction with Theory of Mind

**arXiv ID:** [2605.02307v1](https://arxiv.org/abs/2605.02307v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.02307v1.pdf)

---

## 43. Continual Knowledge Updating in LLM Systems: Learning Through Multi-Timescale Memory Dynamics
...
**PDF:** [下载](http://arxiv.org/pdf/2605.05097v1.pdf)

---

## 44. DART: A Vision-Language Foundation Model for Comprehensive Rope Condition Monitoring

**arXiv ID:** [2605.04943v1](https://arxiv.org/abs/2605.04943v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.04943v1.pdf)

---

## 45. Label-Efficient School Detection from Aerial Imagery via Weakly Supervised Pretraining and Fine-Tuning

**arXiv ID:** [2605.03968v1](https://arxiv.org/abs/2605.03968v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.03968v1.pdf)

---

## 46. Hierarachical Multiagent Reinforcement Learning for Multi-Group Tax Game

**arXiv ID:** [2605.04741v1](https://arxiv.org/abs/2605.04741v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.04741v1.pdf)

---

## 47. MARS-DA: A Hierarchical Reinforcement Learning Framework for Risk-Aware Multi-Agent Bidding in Power Grids

**arXiv ID:** [2605.03142v1](https://arxiv.org/abs/2605.03142v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.03142v1.pdf)

---

## 48. Piper: Efficient Large-Scale MoE Training via Resource Modeling and Pipelined Hybrid Parallelism

**arXiv ID:** [2605.05049v1](https://arxiv.org/abs/2605.05049v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.05049v1.pdf)

---

## 49. Modular Reinforcement Learning For Cooperative Swarms

**arXiv ID:** [2605.04939v1](https://arxiv.org/abs/2605.04939v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.04939v1.pdf)

---

## 50. Large-Scale High-Quality 3D Gaussian Head Reconstruction from Multi-View Captures

**arXiv ID:** [2605.04035v1](https://arxiv.org/abs/2605.04035v1)

**作者:** Evangelos Ntavelis, Sean Wu, Mohamad Shahbazi, Fabio Maninchedda, Dmitry Kostiaev et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.04035v1.pdf)

---

## 51. Steer Like the LLM: Activation Steering that Mimics Prompting

**arXiv ID:** [2605.03907v1](https://arxiv.org/abs/2605.03907v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.03907v1.pdf)

---

## 52. On the Influence of the Feature Computation Budget on Per-Instance Algorithm Selection for Black-Box Optimization

**arXiv ID:** [2605.04954v1](https://arxiv.org/abs/2605.04954v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.04954v1.pdf)

---

## 53. Combining Trained Models in Reinforcement Learning

**arXiv ID:** [2605.02159v1](https://arxiv.org/abs/2605.02159v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.02159v1.pdf)

---

## 54. ShiftLIF: Efficient Multi-Level Spiking Neurons with Power-of-Two Quantization

**arXiv ID:** [2605.01866v1](https://arxiv.org/abs/2605.01866v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.01866v1.pdf)

---

## 55. NeuroRing: Scaling Spiking Neural Networks via Multi-FPGA Bidirectional Ring Topologies and Stream-Dataflow Architectures
...
## 56. Governed Collaborative Memory as Artificial Selection in LLM-Based Multi-Agent Systems

**arXiv ID:** [2605.04264v1](https://arxiv.org/abs/2605.04264v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.04264v1.pdf)

---

## 57. Uno-Orchestra: Parsimonious Agent Routing via Selective Delegation

**arXiv ID:** [2605.05007v1](https://arxiv.org/abs/2605.05007v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.05007v1.pdf)

---

## 58. LLM-enabled Social Agents

**arXiv ID:** [2605.02335v1](https://arxiv.org/abs/2605.02335v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.02335v1.pdf)

---

## 59. Spatiotemporal Convolutions on EEG signal -- A Representation Learning Perspective on Efficient and Explainable EEG Classification with Convolutional Neural Nets

**arXiv ID:** [2605.03874v1](https://arxiv.org/abs/2605.03874v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.03874v1.pdf)

---

## 60. Active Contact Sensing for Robust Robot-to-Human Object Handover

**arXiv ID:** [2605.04610v1](https://arxiv.org/abs/2605.04610v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.04610v1.pdf)

---

## 61. Spiking Sequence Machines and Transformers
...
## 62. Graph-SND: Sparse Aggregation for Behavioral Diversity in Multi-Agent Reinforcement Learning

**arXiv ID:** [2605.05020v1](https://arxiv.org/abs/2605.05020v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.05020v1.pdf)

---

## 63. When Stress Becomes Signal: Detecting Antifragility-Compatible Regimes in Multi-Agent LLM Systems

**arXiv ID:** [2605.02463v2](https://arxiv.org/abs/2605.02463v2)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.02463v2.pdf)

---

## 64. FlowEval: Reference-based Evaluation of Generated User Interfaces

**arXiv ID:** [2605.04165v1](https://arxiv.org/abs/2605.04165v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.04165v1.pdf)

---

## 65. Detecting Hallucinations in Large Language Models via Internal Attention Divergence Signals

**arXiv ID:** [2605.05025v1](https://arxiv.org/abs/2605.05025v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.05025v1.pdf)

---

## 66. Automatically Finding and Validating Unexpected Side-Effects of Interventions on Language Models
...
**PDF:** [下载](http://arxiv.org/pdf/2605.05090v1.pdf)

---

## 67. Direct Product Flow Matching: Decoupling Radial and Angular Dynamics for Few-Shot Adaptation

**arXiv ID:** [2605.05054v1](https://arxiv.org/abs/2605.05054v1)

**作者:** Hongxu Chen, Yanghao Wang, Bowei Zhu, Hongxiang Li, Zhen Wang et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.05054v1.pdf)

---

## 68. Preference-Based Self-Distillation: Beyond KL Matching via Reward Regularization

**arXiv ID:** [2605.05040v1](https://arxiv.org/abs/2605.05040v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.05040v1.pdf)

---

## 69. Position: Embodied AI Requires a Privacy-Utility Trade-off

**arXiv ID:** [2605.05017v1](https://arxiv.org/abs/2605.05017v1)

**作者:** Xiaoliang Fan, Jiarui Chen, Zhuodong Liu, Ziqi Yang, Peixuan Xu et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.05017v1.pdf)

---

## 70. Misaligned by Reward: Socially Undesirable Preferences in LLMs

**arXiv ID:** [2605.05003v1](https://arxiv.org/abs/2605.05003v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.05003v1.pdf)

---

## 71. Self-Induced Outcome Potential: Turn-Level Credit Assignment for Agents without Verifiers

**arXiv ID:** [2605.04984v1](https://arxiv.org/abs/2605.04984v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.04984v1.pdf)

---

## 72. A unified Benchmark for Multi-Frame Image Restoration under Severe Refractive Warping

**arXiv ID:** [2605.05079v1](https://arxiv.org/abs/2605.05079v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.05079v1.pdf)

---

## 73. ScriptHOI: Learning Scripted State Transitions for Open-Vocabulary Human-Object Interaction Detection

**arXiv ID:** [2605.05057v1](https://arxiv.org/abs/2605.05057v1)

**作者:** Minh Anh Nguyen, Quang Huy Tran, Bao Ngoc Le, SuiYang Guang, Tuan Kiet Pham et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.05057v1.pdf)

---

## 74. Reduced-order Neural Modeling with Differentiable Simulation for High-Detail Tactile Perception

**arXiv ID:** [2605.05053v1](https://arxiv.org/abs/2605.05053v1)

**作者:** Yuhu Guo, Zhikai Shen, Jiasheng Qu, Chenghao Qian, Yuming Huang et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.05053v1.pdf)

---

## 75. ELVIS: Ensemble-Calibrated Latent Imagination for Long-Horizon Visual MPC

**arXiv ID:** [2605.04709v1](https://arxiv.org/abs/2605.04709v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.04709v1.pdf)

---

## 76. From Reach to Insert: Tactile-Augmented Precision Assembly under Sub-Millimeter Tolerances

**arXiv ID:** [2605.04649v1](https://arxiv.org/abs/2605.04649v1)

**作者:** Xinpan Meng, Siyao Huang, JingPu Yang, Muyuan Ma, Zhenghua Ma et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.04649v1.pdf)

---

## 77. Physical Foundation Models: Fixed hardware implementations of large-scale neural networks
...
## 78. Physics-Grounded Multi-Agent Architecture for Traceable, Risk-Aware Human-AI Decision Support in Manufacturing

**arXiv ID:** [2605.04003v1](https://arxiv.org/abs/2605.04003v1)

**作者:** Danny Hoang, Ryan Matthiessen, Christopher Miller, Nasir Mannan, Ruby ElKharboutly et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.04003v1.pdf)

---

## 79. Coordination as an Architectural Layer for LLM-Based Multi-Agent Systems
...
**PDF:** [下载](http://arxiv.org/pdf/2605.03310v1.pdf)

---

## 80. FL-Sailer: Efficient and Privacy-Preserving Federated Learning for Scalable Single-Cell Epigenetic Data Analysis via Adaptive Sampling

**arXiv ID:** [2605.04519v1](https://arxiv.org/abs/2605.04519v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.04519v1.pdf)

---

## 81. Adapt or Forget: Provable Tradeoffs Between Adam and SGD in Nonstationary Optimization

**arXiv ID:** [2605.04269v1](https://arxiv.org/abs/2605.04269v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.04269v1.pdf)

---

## 82. Architectural Constraints Alignment in AI-assisted, Platform-based Service Development

**arXiv ID:** [2605.04973v1](https://arxiv.org/abs/2605.04973v1)

**作者:** Julius Irion, Moritz Leugers, Paul Hartwig, Simon Kling, Tachmyrat Annayev et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.04973v1.pdf)

---

## 83. Flow Sampling: Learning to Sample from Unnormalized Densities via Denoising Conditional Processes

**arXiv ID:** [2605.03984v1](https://arxiv.org/abs/2605.03984v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.03984v1.pdf)

---

## 84. Proximal Projection for Doubly Sparse Regularized Models

**arXiv ID:** [2605.05093v1](https://arxiv.org/abs/2605.05093v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.05093v1.pdf)

---

## 85. Conceptors for Semantic Steering

**arXiv ID:** [2605.04980v1](https://arxiv.org/abs/2605.04980v1)

**作者:** Ilias Triantafyllopoulos, Young-Min Cho, Ren Tao, Miranda Muqing Miao, Sunny Rai et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.04980v1.pdf)

---

## 86. TabEmbed: Benchmarking and Learning Generalist Embeddings for Tabular Understanding

**arXiv ID:** [2605.04962v1](https://arxiv.org/abs/2605.04962v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.04962v1.pdf)

---

## 87. Sentiment Analysis and Customer Satisfaction Prediction on E-Commerce Platforms Based on YouTube Comments Using the XGBoost Algorithm

**arXiv ID:** [2605.04887v1](https://arxiv.org/abs/2605.04887v1)

**作者:** Ridho Benedictus Togi Manik, Muhammad Aqil Ramadhan, Ihsan Maulana Yusuf, Luluk Muthoharoh, Ardika Satria et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.04887v1.pdf)

---

## 88. External Validation of Deep Learning Models for BI-RADS Breast Density Prediction from Ultrasound Images

**arXiv ID:** [2605.05082v1](https://arxiv.org/abs/2605.05082v1)

**作者:** Yuxuan Chen, Arianna Bunnell, Yanqi Xu, Haoyan Yang, Thomas K. Wolfgruber et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.05082v1.pdf)

---

## 89. Dream-MPC: Gradient-Based Model Predictive Control with Latent Imagination

**arXiv ID:** [2605.04568v1](https://arxiv.org/abs/2605.04568v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.04568v1.pdf)

---

## 90. Interpreting V1 Population Activity via Image-Neural Latent Representation Alignment

**arXiv ID:** [2605.04309v1](https://arxiv.org/abs/2605.04309v1)

**作者:** Xin Wang, Zhuangzhi Gao, Hongyi Qin, Zhongli Wu, Feixiang Zhou et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.04309v1.pdf)

---

## 91. DAO-enabled decentralized physical AI: A new paradigm for human-machine collaboration

**arXiv ID:** [2605.04522v1](https://arxiv.org/abs/2605.04522v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.04522v1.pdf)

---

## 92. High-Dimensional Statistics: Reflections on Progress and Open Problems

**arXiv ID:** [2605.05076v1](https://arxiv.org/abs/2605.05076v1)

**作者:** Arian Maleki, Subhabrata Sen, Sivaraman Balakrishna, Verena Zuber, Chao Gao et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.05076v1.pdf)

---

## 93. Training-Time Batch Normalization Reshapes Local Partition Geometry in Piecewise-Affine Networks

**arXiv ID:** [2605.04946v1](https://arxiv.org/abs/2605.04946v1)

**作者:** Xuan Qi, Yi Wei, Fanqi Yu, Furao shen, Vittorio Murino et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.04946v1.pdf)

---

## 94. Entropic Riemannian Neural Optimal Transport

**arXiv ID:** [2605.04255v1](https://arxiv.org/abs/2605.04255v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.04255v1.pdf)

---

## 95. Perturbation is All You Need for Extrapolating Language Models

**arXiv ID:** [2605.04344v1](https://arxiv.org/abs/2605.04344v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.04344v1.pdf)

---

## 96. Adaptive Learning Strategies for AoA-Based Outdoor Localization: A Comprehensive Framework

**arXiv ID:** [2605.05055v1](https://arxiv.org/abs/2605.05055v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.05055v1.pdf)

---

## 97. Skill Neologisms: Towards Skill-based Continual Learning

**arXiv ID:** [2605.04970v1](https://arxiv.org/abs/2605.04970v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.04970v1.pdf)

---

## 98. Why Expert Alignment Is Hard: Evidence from Subjective Evaluation

**arXiv ID:** [2605.04972v1](https://arxiv.org/abs/2605.04972v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.04972v1.pdf)

---

## 99. Self-Attention as Transport: Limits of Symmetric Spectral Diagnostics

**arXiv ID:** [2605.04893v1](https://arxiv.org/abs/2605.04893v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.04893v1.pdf)

---

## 100. Height-Guided Projection Reparameterization for Camera-LiDAR Occupancy

**arXiv ID:** [2605.05072v1](https://arxiv.org/abs/2605.05072v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.05072v1.pdf)

---

## 101. Few-Shot Learning Pipeline for Monkeypox Skin Disease Classification Using CNN Feature Extractors

**arXiv ID:** [2605.05034v1](https://arxiv.org/abs/2605.05034v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.05034v1.pdf)

---

## 102. Prompt-Anchored Vision-Text Distillation for Lifelong Person Re-identification

**arXiv ID:** [2605.05027v1](https://arxiv.org/abs/2605.05027v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.05027v1.pdf)

---

## 103. Low-Rank Adaptation of Geospatial Foundation Models for Wildfire Mapping Using Sentinel-2 Data

**arXiv ID:** [2605.04989v1](https://arxiv.org/abs/2605.04989v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.04989v1.pdf)

---

## 104. Robust volatility updates for Hierarchical Gaussian Filtering
...
## 105. SWE-WebDevBench: Evaluating Coding Agent Application Platforms as Virtual Software Agencies

**arXiv ID:** [2605.04637v1](https://arxiv.org/abs/2605.04637v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.04637v1.pdf)

---

## 106. YOTOnet: Zero-Shot Cross-Domain Fault Diagnosis via Domain-Conditioned Mixture of Experts

**arXiv ID:** [2605.04528v1](https://arxiv.org/abs/2605.04528v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.04528v1.pdf)

---

## 107. FitText: Evolving Agent Tool Ecologies via Memetic Retrieval

**arXiv ID:** [2605.02411v1](https://arxiv.org/abs/2605.02411v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.02411v1.pdf)

---

## 108. Regime-Conditioned Evaluation in Multi-Context Bayesian Optimization

**arXiv ID:** [2605.04895v1](https://arxiv.org/abs/2605.04895v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.04895v1.pdf)

---

## 109. From Language to Logic: A Theoretical Architecture for VLM-Grounded Safe Navigation

**arXiv ID:** [2605.04327v1](https://arxiv.org/abs/2605.04327v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.04327v1.pdf)

---

## 110. Think-Aloud Reshapes Automated Cognitive Model Discovery Beyond Behavior

**arXiv ID:** [2605.05091v1](https://arxiv.org/abs/2605.05091v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.05091v1.pdf)

---

## 111. Look Once, Beam Twice: Camera-Primed Real-Time Double-Directional mmWave Beam Management for Vehicular Connectivity

**arXiv ID:** [2605.05071v1](https://arxiv.org/abs/2605.05071v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.05071v1.pdf)

---

## 112. Reliable Modeling of Distribution Shifts via Displacement-Reshaped Optimal Transport

**arXiv ID:** [2605.04965v1](https://arxiv.org/abs/2605.04965v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.04965v1.pdf)

---

## 113. Enhanced 3D Brain Tumor Segmentation Using Assorted Precision Training

**arXiv ID:** [2605.04008v1](https://arxiv.org/abs/2605.04008v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.04008v1.pdf)

---

## 114. Pretrained Model Representations as Acquisition Signals for Active Learning of MLIPs

**arXiv ID:** [2605.03964v1](https://arxiv.org/abs/2605.03964v1)

**作者:** Eszter Varga-Umbrich, Shikha Surana, Paul Duckworth, Jules Tilly, Olivier Peltre et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.03964v1.pdf)

---

## 115. From Data Lifting to Continuous Risk Estimation: A Process-Aware Pipeline for Predictive Monitoring of Clinical Pathways

**arXiv ID:** [2605.03895v1](https://arxiv.org/abs/2605.03895v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.03895v1.pdf)

---

## 116. A Comparative Study of PyCaret AutoML and CNN-BiLSTM for Binary Hate Speech Detection in Indonesian Twitter

**arXiv ID:** [2605.04885v1](https://arxiv.org/abs/2605.04885v1)

**作者:** Tanty Widiyastuti, Mayada, Adisty Syawalda Ariyanto, Luluk Muthoharoh, Ardika Satria et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.04885v1.pdf)

---

## 117. CARD: A Multi-Modal Automotive Dataset for Dense 3D Reconstruction in Challenging Road Topography

**arXiv ID:** [2605.05014v1](https://arxiv.org/abs/2605.05014v1)

**作者:** Gasser Elazab, Frank Neuhaus, Tilman Koß, Malte Splietker, Aditya Date et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.05014v1.pdf)

---

## 118. Exploring Clustering Capability of Inpainting Model Embeddings for Pattern-based Individual Identification

**arXiv ID:** [2605.04904v1](https://arxiv.org/abs/2605.04904v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.04904v1.pdf)

---

## 119. Practical validation of synthetic pre-crash scenarios

**arXiv ID:** [2605.04564v1](https://arxiv.org/abs/2605.04564v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.04564v1.pdf)

---

## 120. Exact and Evolutionary Algorithms for Sequential Multi-Objective Transmission Topology Planning

**arXiv ID:** [2605.03753v1](https://arxiv.org/abs/2605.03753v1)

**作者:** Job Groeneveld, Miguel Muñoz, Jan Viebahn, Alessandro Zocca

**分类:** math.OC, cs.NE, eess.SY
...
**PDF:** [下载](http://arxiv.org/pdf/2605.03753v1.pdf)

---

## 121. SNNF: An SNN-based Near-Sensor Noise Filter for Dynamic Vision Sensors

**arXiv ID:** [2605.01937v1](https://arxiv.org/abs/2605.01937v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.01937v1.pdf)

---

## 122. Probe-Geometry Alignment: Erasing the Cross-Sequence Memorization Signature Below Chance

**arXiv ID:** [2605.01699v2](https://arxiv.org/abs/2605.01699v2)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.01699v2.pdf)

---

## 123. Scalable Learning in Structured Recurrent Spiking Neural Networks without Backpropagation
...
## 124. Multiscale Euclidean Network Trajectories: Second-Moment Geometry, Attribution, and Change Points

**arXiv ID:** [2605.04589v1](https://arxiv.org/abs/2605.04589v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.04589v1.pdf)

---

## 125. From Video-to-PDE: Data-Driven Discovery of Nonlinear Dye Plume Dynamics

**arXiv ID:** [2605.04535v1](https://arxiv.org/abs/2605.04535v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.04535v1.pdf)

---

## 126. AI-Aided Advancements in Autonomous Underwater Vehicle Navigation

**arXiv ID:** [2605.04672v1](https://arxiv.org/abs/2605.04672v1)

**作者:** Guy Damari, Zeev Yampolsky, Nadav Cohen, Arup Kumar Sahoo, Jeryes Danial et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.04672v1.pdf)

---

## 127. Right Model, Right Time: Real-Time Cascaded-Fidelity MPC for Bipedal Walking

**arXiv ID:** [2605.04607v1](https://arxiv.org/abs/2605.04607v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.04607v1.pdf)

---

## 128. A Comparative Analysis of Machine Learning and Deep Learning Models for Tweet Sentiment Classification: A Case Study on the Sentiment140 Dataset

**arXiv ID:** [2605.04888v1](https://arxiv.org/abs/2605.04888v1)

**作者:** Vita Anggraini, Cintya Bella, Bastian, Luluk Muthoharoh, Ardika Satria et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.04888v1.pdf)

---

## 129. PHALAR: Phasors for Learned Musical Audio Representations

**arXiv ID:** [2605.03929v1](https://arxiv.org/abs/2605.03929v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.03929v1.pdf)

---

## 130. Why Geometric Continuity Emerges in Deep Neural Networks: Residual Connections and Rotational Symmetry Breaking

**arXiv ID:** [2605.04971v1](https://arxiv.org/abs/2605.04971v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.04971v1.pdf)

---

## 131. When Does Gene Regulatory Network Inference Break? A Controlled Diagnostic Study of Causal and Correlational Methods on Single-Cell Data

**arXiv ID:** [2605.04930v1](https://arxiv.org/abs/2605.04930v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.04930v1.pdf)

---

## 132. Integrating Feature Correlation in Differential Privacy with Applications in DP-ERM

**arXiv ID:** [2605.03945v1](https://arxiv.org/abs/2605.03945v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.03945v1.pdf)

---

## 133. TabSurv: Adapting Modern Tabular Neural Networks to Survival Analysis

**arXiv ID:** [2605.03944v1](https://arxiv.org/abs/2605.03944v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.03944v1.pdf)

---

## 134. Ecologically-Constrained Task Arithmetic for Multi-Taxa Bioacoustic Classifiers Without Shared Data

**arXiv ID:** [2605.03914v1](https://arxiv.org/abs/2605.03914v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.03914v1.pdf)

---

## 135. A Domain Incremental Continual Learning Benchmark for ICU Time Series Model Transportability

**arXiv ID:** [2605.03832v1](https://arxiv.org/abs/2605.03832v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.03832v1.pdf)

---

## 136. Koopman Identification of Nonlinear Systems via Reservoir Liftings

**arXiv ID:** [2605.04917v1](https://arxiv.org/abs/2605.04917v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.04917v1.pdf)

---

## 137. Symmetry-Protected Lyapunov Neutral Modes in Equivariant Recurrent Networks

**arXiv ID:** [2605.03338v1](https://arxiv.org/abs/2605.03338v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.03338v1.pdf)

---

## 138. MPCS: Neuroplastic Continual Learning via Multi-Component Plasticity and Topology-Aware EWC

**arXiv ID:** [2605.02509v1](https://arxiv.org/abs/2605.02509v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.02509v1.pdf)

---

## 139. Training Non-Differentiable Networks via Optimal Transport

**arXiv ID:** [2605.01928v1](https://arxiv.org/abs/2605.01928v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.01928v1.pdf)

---

## 140. Geometric analysis of attractor boundaries and storage capacity limits in kernel Hopfield networks
...
## 141. Evolving Idea Graphs with Learnable Edits-and-Commits for Multi-Agent Scientific Ideation

**arXiv ID:** [2605.04922v1](https://arxiv.org/abs/2605.04922v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.04922v1.pdf)

---

## 142. MemFlow: Intent-Driven Memory Orchestration for Small Language Model Agents

**arXiv ID:** [2605.03312v1](https://arxiv.org/abs/2605.03312v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.03312v1.pdf)

---

## 143. Executor-Side Progressive Risk-Gated Actuation for Agentic AI in Wireless Supervisory Control

**arXiv ID:** [2605.02697v1](https://arxiv.org/abs/2605.02697v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.02697v1.pdf)

---

## 144. Symbolic Regression via Neural Networks

**arXiv ID:** [2605.04337v1](https://arxiv.org/abs/2605.04337v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.04337v1.pdf)

---

## 145. DALight-3D: A Lightweight 3D U-Net for Brain Tumor Segmentation from Multi-Modal MRI

**arXiv ID:** [2605.04518v1](https://arxiv.org/abs/2605.04518v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.04518v1.pdf)

---

## 146. Complex Equation Learner: Rational Symbolic Regression with Gradient Descent in Complex Domain

**arXiv ID:** [2605.03841v1](https://arxiv.org/abs/2605.03841v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.03841v1.pdf)

---

## 147. On-line Learning in Tree MDPs by Treating Policies as Bandit Arms

**arXiv ID:** [2605.04979v1](https://arxiv.org/abs/2605.04979v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.04979v1.pdf)

---

## 148. A Closed-Form Adaptive-Landmark Kernel for Certified Point-Cloud and Graph Classification
...
**PDF:** [下载](http://arxiv.org/pdf/2605.04046v1.pdf)

---

## 149. Optimal Posterior Sampling for Policy Identification in Tabular Markov Decision Processes

**arXiv ID:** [2605.03921v1](https://arxiv.org/abs/2605.03921v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.03921v1.pdf)

---

## 150. Graph Neural Networks in the Wilson Loop Representation of Abelian Lattice Gauge Theories

**arXiv ID:** [2605.03901v1](https://arxiv.org/abs/2605.03901v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.03901v1.pdf)
