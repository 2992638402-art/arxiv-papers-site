# arXiv 每日精选 - 2026-05-08

> 今日为您精选 50 篇高质量 AI/ML 论文

## 1. Towards Annotation-Free Validation of MLLMs: A Vision-Language Logical Consistency Metric

**arXiv ID:** [2605.06201v1](https://arxiv.org/abs/2605.06201v1)

**作者:** Ying Gu, Mei Chee Leong, Hui Li Tan, Shangbo Mao, Liyuan Li et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.06173v1.pdf)
...
**作者:** Xiaoyu Wu, Yifei Wang, Tsu-Jui Fu, Liang-Chieh Chen, Zhe Gan et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.05206v1.pdf)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.06185v1.pdf)
...
## 6. Joint Treatment Effect Estimation from Incomplete Healthcare Data: Temporal Causal Normalizing Flows with LLM-driven Evolutionary MNAR Imputation

**arXiv ID:** [2605.05125v1](https://arxiv.org/abs/2605.05125v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.05125v1.pdf)

---

## 7. Rollout Pass-Rate Control: Steering Binary-Reward RL Toward Its Most Informative Regime

**arXiv ID:** [2605.05112v1](https://arxiv.org/abs/2605.05112v1)

**作者:** Tianshu Zhu, Wenyu Zhang, Xiaoying Zuo, Lun Tian, Haotian Zhao et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.05112v1.pdf)

---

## 8. Systematic Evaluation of Large Language Models for Post-Discharge Clinical Action Extraction
...
**PDF:** [下载](http://arxiv.org/pdf/2605.06191v1.pdf)

---

## 9. Adaptive Policy Selection and Fine-Tuning under Interaction Budgets for Offline-to-Online Reinforcement Learning

**arXiv ID:** [2605.05123v1](https://arxiv.org/abs/2605.05123v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.05123v1.pdf)

---

## 10. Memory Inception: Latent-Space KV Cache Manipulation for Steering LLMs

**arXiv ID:** [2605.06225v1](https://arxiv.org/abs/2605.06225v1)

**作者:** Andy Zeyi Liu, Michael Zhang, Ilana Greenberg, Adam Alnasser, Lucas Baker et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.06225v1.pdf)
...
## 12. Taming the Entropy Cliff: Variable Codebook Size Quantization for Autoregressive Visual Generation

**arXiv ID:** [2605.06207v1](https://arxiv.org/abs/2605.06207v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.06207v1.pdf)

---

## 13. In-Context Black-Box Optimization with Unreliable Feedback

**arXiv ID:** [2605.06187v1](https://arxiv.org/abs/2605.06187v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.06187v1.pdf)

---

## 14. Physiologically Grounded Driver Behavior Classification: SHAP-Driven Elite Feature Selection and Hybrid Gradient Boosting for Multimodal Physiological Signals

**arXiv ID:** [2605.05120v1](https://arxiv.org/abs/2605.05120v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.05120v1.pdf)

---

## 15. Estimating the expected output of wide random MLPs more efficiently than sampling

**arXiv ID:** [2605.05179v1](https://arxiv.org/abs/2605.05179v1)

**作者:** Wilson Wu, Victor Lecomte, Michael Winer, George Robinson, Jacob Hilton et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.05179v1.pdf)

---

## 16. Continual Knowledge Updating in LLM Systems: Learning Through Multi-Timescale Memory Dynamics
...
## 17. Gated Multimodal Learning for Interpretable Property Energy Performance Prediction and Retrofit Scenario Analysis

**arXiv ID:** [2605.05088v1](https://arxiv.org/abs/2605.05088v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.05088v1.pdf)

---

## 18. Joint Consistency: A Unified Test-Time Aggregation Framework via Energy Minimization

**arXiv ID:** [2605.06219v1](https://arxiv.org/abs/2605.06219v1)

**作者:** Yunzhen Yao, Hongye Wang, Yahong Wang, Michael C. Gastpar, Bo Jiang et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.06219v1.pdf)

---

## 19. Contrastive Identification and Generation in the Limit

**arXiv ID:** [2605.06211v1](https://arxiv.org/abs/2605.06211v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.06211v1.pdf)

---

## 20. The Granularity Axis: A Micro-to-Macro Latent Direction for Social Roles in Language Models

**arXiv ID:** [2605.06196v1](https://arxiv.org/abs/2605.06196v1)

**作者:** Chonghan Qin, Xiachong Feng, Ziyun Song, Xiaocheng Feng, Jing Xiong et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.06196v1.pdf)

---

## 21. OPSD Compresses What RLVR Teaches: A Post-RL Compaction Stage for Reasoning Models

**arXiv ID:** [2605.06188v1](https://arxiv.org/abs/2605.06188v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.06188v1.pdf)

---

## 22. Low-Cost Black-Box Detection of LLM Hallucinations via Dynamical System Prediction

**arXiv ID:** [2605.05134v1](https://arxiv.org/abs/2605.05134v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.05134v1.pdf)

---

## 23. On the Hardness of Junking LLMs

**arXiv ID:** [2605.05116v1](https://arxiv.org/abs/2605.05116v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.05116v1.pdf)

---

## 24. Understanding In-Context Learning for Nonlinear Regression with Transformers: Attention as Featurizer

**arXiv ID:** [2605.05176v1](https://arxiv.org/abs/2605.05176v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.05176v1.pdf)

---

## 25. TIDE: Every Layer Knows the Token Beneath the Context

**arXiv ID:** [2605.06216v1](https://arxiv.org/abs/2605.06216v1)

**作者:** Ajay Jaiswal, Lauren Hannah, Han-Byul Kim, Duc Hoang, Mehrdad Farajtabar et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.06216v1.pdf)

---

## 26. Rethinking Adapter Placement: A Dominant Adaptation Module Perspective

**arXiv ID:** [2605.06183v1](https://arxiv.org/abs/2605.06183v1)

**作者:** Suoxin Zhang, Run He, Di Fang, Xiang Tan, Kaixuan Chen et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.06183v1.pdf)

---

## 27. Unified Framework of Distributional Regret in Multi-Armed Bandits and Reinforcement Learning

**arXiv ID:** [2605.05102v1](https://arxiv.org/abs/2605.05102v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.05102v1.pdf)

---

## 28. Safactory: A Scalable Agent Factory for Trustworthy Autonomous Intelligence

**arXiv ID:** [2605.06230v1](https://arxiv.org/abs/2605.06230v1)

**作者:** Xinquan Chen, Zhenyun Yin, Shan He, Bin Huang, Shanzhe Lei et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.06230v1.pdf)

---

## 29. FunctionalAgent: Towards end-to-end on-top functional design

**arXiv ID:** [2605.06215v1](https://arxiv.org/abs/2605.06215v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.06215v1.pdf)

---

## 30. Post Reasoning: Improving the Performance of Non-Thinking Models at No Cost

**arXiv ID:** [2605.06165v1](https://arxiv.org/abs/2605.06165v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.06165v1.pdf)

---

## 31. PSK at SemEval-2026 Task 9: Multilingual Polarization Detection Using Ensemble Gemma Models with Synthetic Data Augmentation
...
**PDF:** [下载](http://arxiv.org/pdf/2605.05159v1.pdf)
...
**arXiv ID:** [2605.05151v1](https://arxiv.org/abs/2605.05151v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.05151v1.pdf)

---

## 33. Proximal Projection for Doubly Sparse Regularized Models
...
**arXiv ID:** [2605.06226v1](https://arxiv.org/abs/2605.06226v1)

**作者:** Tianyu Liu, Wangjie Zheng, Rui Yang, Benny Kai Guo Loo, Hui Zhang et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.06226v1.pdf)

---

## 35. What Matters in Practical Learned Image Compression

**arXiv ID:** [2605.05148v1](https://arxiv.org/abs/2605.05148v1)

**作者:** Kedar Tatwawadi, Parisa Rahimzadeh, Zhanghao Sun, Zhiqi Chen, Ziyun Yang et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.05148v1.pdf)

---

## 36. On the Wasserstein Gradient Flow Interpretation of Drifting Models

**arXiv ID:** [2605.05118v1](https://arxiv.org/abs/2605.05118v1)

**作者:** Arthur Gretton, Li Kevin Wenliang, Alexandre Galashov, James Thornton, Valentin De Bortoli et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.05118v1.pdf)

---

## 37. Manifold Steering Reveals the Shared Geometry of Neural Network Representation and Behavior

**arXiv ID:** [2605.05115v1](https://arxiv.org/abs/2605.05115v1)

**作者:** Daniel Wurgaft, Can Rager, Matthew Kowal, Vasudev Shyam, Sheridan Feucht et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.05115v1.pdf)

---

## 38. Building informative materials datasets beyond targeted objectives

**arXiv ID:** [2605.05104v1](https://arxiv.org/abs/2605.05104v1)

**作者:** Rafael Espinosa Castañeda, Ashley Dale, Hongchen Wang, Yonatan Kurniawan, Hao Wan et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.05104v1.pdf)

---

## 39. Beyond Fixed Benchmarks and Worst-Case Attacks: Dynamic Boundary Evaluation for Language Models

**arXiv ID:** [2605.06213v1](https://arxiv.org/abs/2605.06213v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.06213v1.pdf)

---

## 40. Super-Level-Set Regression: Conditional Quantiles via Volume Minimization
...
## 41. Sharp Capacity Thresholds in Linear Associative Memory: From Winner-Take-All to Listwise Retrieval

**arXiv ID:** [2605.05189v1](https://arxiv.org/abs/2605.05189v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.05189v1.pdf)

---

## 42. Human-AI Co-Mentorship in Project-Based Learning: A Case Study in Financial Forecasting

**arXiv ID:** [2605.05144v1](https://arxiv.org/abs/2605.05144v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.05144v1.pdf)

---

## 43. Soft Deterministic Policy Gradient with Gaussian Smoothing

**arXiv ID:** [2605.06228v1](https://arxiv.org/abs/2605.06228v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.06228v1.pdf)

---

## 44. BioMedArena: An Open-source Toolkit for Building and Evaluating Biomedical Deep Research Agents

**arXiv ID:** [2605.06177v1](https://arxiv.org/abs/2605.06177v1)

**作者:** Jinge Wu, Hongjian Zhou, Mingde Zeng, Jiayuan Zhu, Junde Wu et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.06177v1.pdf)

---

## 45. Proactive Instance Navigation with Comparative Judgment for Ambiguous User Queries
...
## 46. Transformed Latent Variable Multi-Output Gaussian Processes

**arXiv ID:** [2605.05133v1](https://arxiv.org/abs/2605.05133v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.05133v1.pdf)

---

## 47. Conditional outlier detection for clinical alerting

**arXiv ID:** [2605.05124v1](https://arxiv.org/abs/2605.05124v1)

**作者:** Milos Hauskrecht, Michal Valko, Shyam Visweswaran, Iyad Batal, Gilles Clermont et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.05124v1.pdf)

---

## 48. Price of Fairness in Short-Term and Long-Term Algorithmic Selections

**arXiv ID:** [2605.06227v1](https://arxiv.org/abs/2605.06227v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.06227v1.pdf)

---

## 49. How Long Does Infinite Width Last? Signal Propagation in Long-Range Linear Recurrences

**arXiv ID:** [2605.05113v1](https://arxiv.org/abs/2605.05113v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.05113v1.pdf)

---

## 50. A Bayesian Approach for Task-Specific Next-Best-View Selection with Uncertain Geometry

**arXiv ID:** [2605.05095v1](https://arxiv.org/abs/2605.05095v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.05095v1.pdf)
