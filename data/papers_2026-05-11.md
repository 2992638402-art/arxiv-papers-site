# arXiv 每日精选 - 2026-05-11

> 今日为您精选 150 篇高质量 AI/ML 论文

## 1. WeatherSyn: An Instruction Tuning MLLM For Weather Forecasting Report Generation

**arXiv ID:** [2605.07522v1](https://arxiv.org/abs/2605.07522v1)

**作者:** Zinan Zheng, Yang Liu, Nuo Chen, Juepeng Zheng, Hong Cheng et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07522v1.pdf)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.06341v1.pdf)

---

## 3. MASPO: Joint Prompt Optimization for LLM-based Multi-Agent Systems

**arXiv ID:** [2605.06623v1](https://arxiv.org/abs/2605.06623v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.06623v1.pdf)

---

## 4. Decentralized Diffusion Policy Learning for Enhanced Exploration in Cooperative Multi-agent Reinforcement Learning

**arXiv ID:** [2605.07101v1](https://arxiv.org/abs/2605.07101v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07101v1.pdf)

---

## 5. Your Language Model is Its Own Critic: Reinforcement Learning with Value Estimation from Actor's Internal States

**arXiv ID:** [2605.07579v1](https://arxiv.org/abs/2605.07579v1)

**作者:** Yunho Choi, Jongwon Lim, Woojin Ahn, Minjae Oh, Jeonghoon Shim et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07579v1.pdf)

---

## 6. InterLV-Search: Benchmarking Interleaved Multimodal Agentic Search

**arXiv ID:** [2605.07510v1](https://arxiv.org/abs/2605.07510v1)

**作者:** Bohan Hou, Jiuning Gu, Jiayan Guo, Ronghao Dang, Sicong Leng et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07510v1.pdf)

---

## 7. Learning Visual Feature-Based World Models via Residual Latent Action

**arXiv ID:** [2605.07079v1](https://arxiv.org/abs/2605.07079v1)

**作者:** Xinyu Zhang, Zhengtong Xu, Yutian Tao, Yeping Wang, Yu She et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07079v1.pdf)

---

## 8. SEIF: Self-Evolving Reinforcement Learning for Instruction Following

**arXiv ID:** [2605.07465v1](https://arxiv.org/abs/2605.07465v1)

**作者:** Qingyu Ren, Qianyu He, Jiajie Zhu, Xingzhou Chen, Jingwen Chang et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07465v1.pdf)

---

## 9. AT-VLA: Adaptive Tactile Injection for Enhanced Feedback Reaction in Vision-Language-Action Models

**arXiv ID:** [2605.07308v1](https://arxiv.org/abs/2605.07308v1)

**作者:** Xiaoqi Li, Muhe Cai, Jiadong Xu, Juan Zhu, Hongwei Fan et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07308v1.pdf)

---

## 10. LithoBench: Benchmarking Large Multimodal Models for Remote-Sensing Lithology Interpretation

**arXiv ID:** [2605.07640v1](https://arxiv.org/abs/2605.07640v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07640v1.pdf)

---

## 11. Open-Ended Task Discovery via Bayesian Optimization

**arXiv ID:** [2605.07572v1](https://arxiv.org/abs/2605.07572v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07572v1.pdf)

---

## 12. Multi-Dimensional Evaluation of LLMs for Grammatical Error Correction

**arXiv ID:** [2605.07635v1](https://arxiv.org/abs/2605.07635v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07635v1.pdf)

---

## 13. Intent-Driven Semantic ID Generation for Grounded Conversational News Recommendation

**arXiv ID:** [2605.07613v1](https://arxiv.org/abs/2605.07613v1)

**作者:** Hongyang Su, Beibei Kong, Lei Cheng, Chengxiang Zhuo, Zang Li et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07613v1.pdf)

---

## 14. PathPainter: Transferring the Generalization Ability of Image Generation Models to Embodied Navigation

**arXiv ID:** [2605.07496v1](https://arxiv.org/abs/2605.07496v1)

**作者:** Yijin Wang, Yuru Tian, Xijie Huang, Weiqi Gai, Mo Zhu et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07496v1.pdf)

---

## 15. Escaping the Diversity Trap in Robotic Manipulation via Anchor-Centric Adaptation

**arXiv ID:** [2605.07381v1](https://arxiv.org/abs/2605.07381v1)

**作者:** Yanzhe Chen, Kevin Yuchen Ma, Qi Lv, Yiqi Lin, Zechen Bai et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07381v1.pdf)

---

## 16. MDN: Parallelizing Stepwise Momentum for Delta Linear Attention

**arXiv ID:** [2605.05838v1](https://arxiv.org/abs/2605.05838v1)

**作者:** Yulong Huang, Xiang Liu, Hongxiang Huang, Xiaopeng Lin, Zunchang Liu et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.05838v1.pdf)

---

## 17. Post-training makes large language models less human-like

**arXiv ID:** [2605.07632v1](https://arxiv.org/abs/2605.07632v1)

**作者:** Marcel Binz, Elif Akata, Abdullah Almaatouq, Mohammed Alsobay, Oleksii Ariasov et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07632v1.pdf)

---

## 18. Hierarchical Task Network Planning with LLM-Generated Heuristics

**arXiv ID:** [2605.07707v1](https://arxiv.org/abs/2605.07707v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07707v1.pdf)

---

## 19. Hierarchical Dual-Subspace Decoupling for Continual Learning in Vision-Language Models

**arXiv ID:** [2605.07512v1](https://arxiv.org/abs/2605.07512v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07512v1.pdf)

---

## 20. PISTO: Proximal Inference for Stochastic Trajectory Optimization

**arXiv ID:** [2605.07215v1](https://arxiv.org/abs/2605.07215v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07215v1.pdf)

---

## 21. Recursive Agent Optimization
...
**PDF:** [下载](http://arxiv.org/pdf/2605.06639v1.pdf)

---

## 22. FactoryBench: Evaluating Industrial Machine Understanding

**arXiv ID:** [2605.07675v1](https://arxiv.org/abs/2605.07675v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07675v1.pdf)

---

## 23. Guidance Is Not a Hyperparameter: Learning Dynamic Control in Diffusion Language Models

**arXiv ID:** [2605.07701v1](https://arxiv.org/abs/2605.07701v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07701v1.pdf)

---

## 24. Not All Tokens Learn Alike: Attention Entropy Reveals Heterogeneous Signals in RL Reasoning

**arXiv ID:** [2605.07660v1](https://arxiv.org/abs/2605.07660v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07660v1.pdf)

---

## 25. Why do Large Language Models Fail in Low-resource Translation? Unraveling the Token Dynamics of Large Language Models for Machine Translation

**arXiv ID:** [2605.07533v1](https://arxiv.org/abs/2605.07533v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07533v1.pdf)

---

## 26. ExpThink: Experience-Guided Reinforcement Learning for Adaptive Chain-of-Thought Compression

**arXiv ID:** [2605.07501v1](https://arxiv.org/abs/2605.07501v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07501v1.pdf)

---

## 27. EggHand: A Multimodal Foundation Model for Egocentric Hand Pose Forecasting

**arXiv ID:** [2605.07642v1](https://arxiv.org/abs/2605.07642v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07642v1.pdf)

---

## 28. PolarVLM: Bridging the Semantic-Physical Gap in Vision-Language Models

**arXiv ID:** [2605.07574v1](https://arxiv.org/abs/2605.07574v1)

**作者:** Yuliang Li, Chu Zhou, Heng Guo, Boxin Shi, Imari Sato et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07574v1.pdf)

---

## 29. Implicit Preference Alignment for Human Image Animation

**arXiv ID:** [2605.07545v1](https://arxiv.org/abs/2605.07545v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07545v1.pdf)

---

## 30. BrickCraft: Visuomotor Skill Composition with Situated Manual Guidance for Long-Horizon Interlocking Brick Assembly

**arXiv ID:** [2605.07605v1](https://arxiv.org/abs/2605.07605v1)

**作者:** Jichuan Yu, Bowei Li, Zhenran Tang, Guanxing Lu, Chuxiong Hu et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07605v1.pdf)

---

## 31. The Causally Emergent Alignment Hypothesis: Causal Emergence Aligns with and Predicts Final Reward in Reinforcement Learning Agents

**arXiv ID:** [2605.06746v1](https://arxiv.org/abs/2605.06746v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.06746v1.pdf)

---

## 32. Sustaining Cooperation in Populations Guided by AI: A Folk Theorem for LLMs

**arXiv ID:** [2605.06525v1](https://arxiv.org/abs/2605.06525v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.06525v1.pdf)

---

## 33. DRIP-R: A Benchmark for Decision-Making and Reasoning Under Real-World Policy Ambiguity in the Retail Domain

**arXiv ID:** [2605.07699v1](https://arxiv.org/abs/2605.07699v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07699v1.pdf)

---

## 34. Revisiting Transformer Layer Parameterization Through Causal Energy Minimization

**arXiv ID:** [2605.07588v1](https://arxiv.org/abs/2605.07588v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07588v1.pdf)

---

## 35. Tracing the Arrow of Time: Diagnosing Temporal Information Flow in Video-LLMs

**arXiv ID:** [2605.07568v1](https://arxiv.org/abs/2605.07568v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07568v1.pdf)

---

## 36. TCMIIES: A Browser-Based LLM-Powered Intelligent Information Extraction System for Academic Literature

**arXiv ID:** [2605.07507v1](https://arxiv.org/abs/2605.07507v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07507v1.pdf)

---

## 37. Search-based Robustness Testing of Laptop Refurbishing Robotic Software

**arXiv ID:** [2605.07530v1](https://arxiv.org/abs/2605.07530v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07530v1.pdf)

---

## 38. Dr-BA: Separable Optimization for Direct Radar Bundle Adjustment &amp; Localization

**arXiv ID:** [2605.07041v1](https://arxiv.org/abs/2605.07041v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07041v1.pdf)

---

## 39. HERCULES: Hardware-Efficient, Robust, Continual Learning Neural Architecture Search
...
## 40. Cross-Modal Navigation with Multi-Agent Reinforcement Learning

**arXiv ID:** [2605.06595v1](https://arxiv.org/abs/2605.06595v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.06595v1.pdf)

---

## 41. Improved Model-based Reinforcement Learning with Smooth Kernels

**arXiv ID:** [2605.07218v1](https://arxiv.org/abs/2605.07218v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07218v1.pdf)

---

## 42. Cross-Attention and Encoder-Decoder Transformers: A Logical Characterization

**arXiv ID:** [2605.07705v1](https://arxiv.org/abs/2605.07705v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07705v1.pdf)

---

## 43. Operating Within the Operational Design Domain: Zero-Shot Perception with Vision-Language Models

**arXiv ID:** [2605.07649v1](https://arxiv.org/abs/2605.07649v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07649v1.pdf)

---

## 44. Tacit Knowledge Extraction via Logic Augmented Generation and Active Inference

**arXiv ID:** [2605.07639v1](https://arxiv.org/abs/2605.07639v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07639v1.pdf)

---

## 45. Learning to Communicate Locally for Large-Scale Multi-Agent Pathfinding

**arXiv ID:** [2605.07637v1](https://arxiv.org/abs/2605.07637v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07637v1.pdf)

---

## 46. Debiased Counterfactual Generation via Flow Matching from Observations

**arXiv ID:** [2605.07665v1](https://arxiv.org/abs/2605.07665v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07665v1.pdf)

---

## 47. Stochastic Transition-Map Distillation for Fast Probabilistic Inference

**arXiv ID:** [2605.07661v1](https://arxiv.org/abs/2605.07661v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07661v1.pdf)

---

## 48. TraceAV-Bench: Benchmarking Multi-Hop Trajectory Reasoning over Long Audio-Visual Videos

**arXiv ID:** [2605.07593v1](https://arxiv.org/abs/2605.07593v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07593v1.pdf)

---

## 49. Dynamic Mode Decomposition along Depth in Vision Transformers

**arXiv ID:** [2605.07556v1](https://arxiv.org/abs/2605.07556v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07556v1.pdf)

---

## 50. Is the Future Compatible? Diagnosing Dynamic Consistency in World Action Models

**arXiv ID:** [2605.07514v1](https://arxiv.org/abs/2605.07514v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07514v1.pdf)

---

## 51. Multi-Objective Constraint Inference using Inverse reinforcement learning

**arXiv ID:** [2605.06951v1](https://arxiv.org/abs/2605.06951v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.06951v1.pdf)

---

## 52. Quality-Conditioned Agreement in Automated Short Answer Scoring: Mid-Range Degradation and the Impact of Task-Specific Adaptation

**arXiv ID:** [2605.07647v1](https://arxiv.org/abs/2605.07647v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07647v1.pdf)

---

## 53. Multimodal Stepwise Clinically-Guided Attention Learning for Pathological Complete Response Prediction in Breast Cancer

**arXiv ID:** [2605.07561v1](https://arxiv.org/abs/2605.07561v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07561v1.pdf)

---

## 54. Mind the Gap: Geometrically Accurate Generative Reconstruction from Disjoint Views

**arXiv ID:** [2605.07550v1](https://arxiv.org/abs/2605.07550v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07550v1.pdf)

---

## 55. Discovering Ordinary Differential Equations with LLM-Based Qualitative and Quantitative Evaluation
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07323v1.pdf)

---

## 56. S-LCG: Structured Linear Congruential Generator-Based Deterministic Algorithm for Search and Optimization

**arXiv ID:** [2605.05198v1](https://arxiv.org/abs/2605.05198v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.05198v1.pdf)

---

## 57. Coordination Matters: Evaluation of Cooperative Multi-Agent Reinforcement Learning

**arXiv ID:** [2605.06557v1](https://arxiv.org/abs/2605.06557v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.06557v1.pdf)

---

## 58. TRACE: Transport Alignment Conformal Prediction via Diffusion and Flow Matching Models

**arXiv ID:** [2605.07100v1](https://arxiv.org/abs/2605.07100v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07100v1.pdf)

---

## 59. GASim: A Graph-Accelerated Hybrid Framework for Social Simulation

**arXiv ID:** [2605.07692v1](https://arxiv.org/abs/2605.07692v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07692v1.pdf)

---

## 60. Inference Time Causal Probing in LLMs

**arXiv ID:** [2605.07631v1](https://arxiv.org/abs/2605.07631v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07631v1.pdf)

---

## 61. Gradient Starvation in Binary-Reward GRPO: Why Group-Mean Centering Fails and Why the Simplest Fix Works

**arXiv ID:** [2605.07689v1](https://arxiv.org/abs/2605.07689v1)

**作者:** Wenhua Nie, Jianan Wu, Junlin Liu, Ziwei Li, Zheng Lin et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07689v1.pdf)

---

## 62. Response-G1: Explicit Scene Graph Modeling for Proactive Streaming Video Understanding

**arXiv ID:** [2605.07575v1](https://arxiv.org/abs/2605.07575v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07575v1.pdf)

---

## 63. Beyond GSD-as-Token: Continuous Scale Conditioning for Remote Sensing VLMs

**arXiv ID:** [2605.07562v1](https://arxiv.org/abs/2605.07562v1)

**作者:** Song Zhang, Yanlong Chen, Yilin Li, Yining Chen, Zili Yi et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07562v1.pdf)

---

## 64. VIMCAN: Visual-Inertial 3D Human Pose Estimation with Hybrid Mamba-Cross-Attention Network

**arXiv ID:** [2605.07552v1](https://arxiv.org/abs/2605.07552v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07552v1.pdf)

---

## 65. PhySPRING: Structure-Preserving Reduction of Physics-Informed Twins via GNN

**arXiv ID:** [2605.07687v1](https://arxiv.org/abs/2605.07687v1)

**作者:** Yixiong Jing, Xingyuan Chen, Guangming Wang, Olaf Wysocki, Haibing Wu et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07687v1.pdf)

---

## 66. BioProVLA-Agent: An Affordable, Protocol-Driven, Vision-Enhanced VLA-Enabled Embodied Multi-Agent System with Closed-Loop-Capable Reasoning for Biological Laboratory Manipulation

**arXiv ID:** [2605.07306v1](https://arxiv.org/abs/2605.07306v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07306v1.pdf)

---

## 67. On the Influence of the Feature Computation Budget on Per-Instance Algorithm Selection for Black-Box Optimization
...
## 68. Combining Trained Models in Reinforcement Learning
...
## 69. Statistical Convergence of Spherical First Hitting Diffusion Models

**arXiv ID:** [2605.07625v1](https://arxiv.org/abs/2605.07625v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07625v1.pdf)

---

## 70. Dependence on Early and Late Reverberation of Single-Channel Speaker Distance Estimation

**arXiv ID:** [2605.07694v1](https://arxiv.org/abs/2605.07694v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07694v1.pdf)

---

## 71. ARMOR: An Agentic Framework for Reaction Feasibility Prediction via Adaptive Utility-aware Multi-tool Reasoning

**arXiv ID:** [2605.07103v1](https://arxiv.org/abs/2605.07103v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07103v1.pdf)

---

## 72. Conformal Agent Error Attribution

**arXiv ID:** [2605.06788v1](https://arxiv.org/abs/2605.06788v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.06788v1.pdf)

---

## 73. Almost Sure Convergence Rates of Stochastic Approximation and Reinforcement Learning via a Poisson-Moreau Drift

**arXiv ID:** [2605.07104v1](https://arxiv.org/abs/2605.07104v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07104v1.pdf)

---

## 74. TRACE: Tourism Recommendation with Accountable Citation Evidence

**arXiv ID:** [2605.07677v1](https://arxiv.org/abs/2605.07677v1)

**作者:** Zixu Zhao, Sijin Wang, Yu Hou, Yuanyuan Xu, Yufan Sheng et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07677v1.pdf)

---

## 75. Towards Billion-scale Multi-modal Biometric Search

**arXiv ID:** [2605.07655v1](https://arxiv.org/abs/2605.07655v1)

**作者:** Arka Koner, Chetan S. Naik, Lokesh Kurre, Vivek Raghavan, Barada P. Sabut et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07655v1.pdf)

---

## 76. The Coupling Tax: How Shared Token Budgets Undermine Visible Chain-of-Thought Under Fixed Output Limits

**arXiv ID:** [2605.07686v1](https://arxiv.org/abs/2605.07686v1)

**作者:** Wenhua Nie, Junlin Liu, Jianan Wu, Zijie Meng, Yilong Fan et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07686v1.pdf)

---

## 77. SimCT: Recovering Lost Supervision for Cross-Tokenizer On-Policy Distillation

**arXiv ID:** [2605.07711v1](https://arxiv.org/abs/2605.07711v1)

**作者:** Jie Sun, Mao Zheng, Mingyang Song, Qiyong Zhong, Yilin Cheng et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07711v1.pdf)

---

## 78. Think-with-Rubrics: From External Evaluator to Internal Reasoning Guidance

**arXiv ID:** [2605.07461v1](https://arxiv.org/abs/2605.07461v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07461v1.pdf)

---

## 79. CSR: Infinite-Horizon Real-Time Policies with Massive Cached State Representations

**arXiv ID:** [2605.07325v1](https://arxiv.org/abs/2605.07325v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07325v1.pdf)

---

## 80. Palm-sized Omnidirectional Vision-Based UAV Exploration with Sparse Topological Map Guidance

**arXiv ID:** [2605.07275v1](https://arxiv.org/abs/2605.07275v1)

**作者:** Zirui Wang, Xinjia Luo, Haotian Sun, Jun Ma, Jian Guo et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07275v1.pdf)

---

## 81. Same Brain, Different Prediction: How Preprocessing Choices Undermine EEG Decoding Reliability

**arXiv ID:** [2605.07212v1](https://arxiv.org/abs/2605.07212v1)

**作者:** Dengzhe Hou, Zihao Wu, Lingyu Jiang, Zirui Li, Fangzhou Lin et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07212v1.pdf)

---

## 82. A Unified Measure-Theoretic View of Diffusion, Score-Based, and Flow Matching Generative Models

**arXiv ID:** [2605.06829v1](https://arxiv.org/abs/2605.06829v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.06829v1.pdf)

---

## 83. Social Theory Should Be a Structural Prior for Agentic AI: A Formal Framework for Multi-Agent Social Systems

**arXiv ID:** [2605.07069v1](https://arxiv.org/abs/2605.07069v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07069v1.pdf)

---

## 84. Spectrum-Adaptive Generalization Bounds for Trained Deep Transformers

**arXiv ID:** [2605.07297v1](https://arxiv.org/abs/2605.07297v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07297v1.pdf)

---

## 85. Mathematical Reasoning via Intervention-Based Time-Series Causal Discovery Using LLMs as Concept Mastery Simulators

**arXiv ID:** [2605.07600v1](https://arxiv.org/abs/2605.07600v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07600v1.pdf)

---

## 86. Is She Even Relevant? When BERT Ignores Explicit Gender Cues

**arXiv ID:** [2605.07622v1](https://arxiv.org/abs/2605.07622v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07622v1.pdf)

---

## 87. Every Feedforward Neural Network Definable in an o-Minimal Structure Has Finite Sample Complexity

**arXiv ID:** [2605.07097v1](https://arxiv.org/abs/2605.07097v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07097v1.pdf)

---

## 88. Efficient event-driven retrieval in high-capacity kernel Hopfield networks

**arXiv ID:** [2605.05978v1](https://arxiv.org/abs/2605.05978v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.05978v1.pdf)

---

## 89. QUIVER: Cost-Aware Adaptive Preference Querying in Surrogate-Assisted Evolutionary Multi-Objective Optimization

**arXiv ID:** [2605.04267v1](https://arxiv.org/abs/2605.04267v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.04267v1.pdf)

---

## 90. HBEE: Human Behavioral Entropy Engine -- Pre-Registered Multi-Agent LLM Simulation of Peer-Suspicion-Based Detection Inversion

**arXiv ID:** [2605.07472v1](https://arxiv.org/abs/2605.07472v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07472v1.pdf)

---

## 91. MAGIQ: A Post-Quantum Multi-Agentic AI Governance System with Provable Security

**arXiv ID:** [2605.06933v1](https://arxiv.org/abs/2605.06933v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.06933v1.pdf)

---

## 92. MAVEN: Multi-Agent Verification-Elaboration Network with In-Step Epistemic Auditing

**arXiv ID:** [2605.07646v1](https://arxiv.org/abs/2605.07646v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07646v1.pdf)

---

## 93. Bayesian Fine-tuning in Projected Subspaces

**arXiv ID:** [2605.07706v1](https://arxiv.org/abs/2605.07706v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07706v1.pdf)

---

## 94. Future Validity is the Missing Statistic: From Impossibility to $Φ$-Estimation for Grammar-Faithful Speculative Decoding

**arXiv ID:** [2605.07698v1](https://arxiv.org/abs/2605.07698v1)

**作者:** Wenhua Nie, Zijie Meng, Kun Zou, Zheng Lin, Ziwei Li et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07698v1.pdf)

---

## 95. Toward Better Geometric Representations for Molecule Generative Models

**arXiv ID:** [2605.07693v1](https://arxiv.org/abs/2605.07693v1)

**作者:** Shaoheng Yan, Zian Li, Cai Zhou, Qiaojing Huang, Kai Liu et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07693v1.pdf)

---

## 96. The Moltbook Files: A Harmless Slopocalypse or Humanity's Last Experiment

**arXiv ID:** [2605.07462v1](https://arxiv.org/abs/2605.07462v1)

**作者:** William Brach, Federico Torrielli, Stine Lyngsø Beltoft, Annemette Brok Pirchert, Peter Schneider-Kamp et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07462v1.pdf)

---

## 97. OphEdit: Training-Free Text-Guided Editing of Ophthalmic Surgical Videos

**arXiv ID:** [2605.07695v1](https://arxiv.org/abs/2605.07695v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07695v1.pdf)

---

## 98. FS-I2P:A Hierarchical Focus-Sweep Registration Network with Dynamically Allocated Depth

**arXiv ID:** [2605.07607v1](https://arxiv.org/abs/2605.07607v1)

**作者:** Zhixin Cheng, Yujia Chen, Xujing Tao, Bohao Liao, Xiaotian Yin et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07607v1.pdf)

---

## 99. Probabilistic Object Detection with Conformal Prediction

**arXiv ID:** [2605.07549v1](https://arxiv.org/abs/2605.07549v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07549v1.pdf)

---

## 100. MemCompiler: Compile, Don't Inject -- State-Conditioned Memory for Embodied Agents

**arXiv ID:** [2605.07594v1](https://arxiv.org/abs/2605.07594v1)

**作者:** Xin Ding, Xinrui Wang, Yifan Yang, Hao Wu, Shiqi Jiang et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07594v1.pdf)

---

## 101. TriP: A Triangle Puzzle Approach to Robust Translation Averaging

**arXiv ID:** [2605.07143v1](https://arxiv.org/abs/2605.07143v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07143v1.pdf)

---

## 102. Interpreting V1 Population Activity via Image-Neural Latent Representation Alignment
...
## 103. OrchJail: Jailbreaking Tool-Calling Text-to-Image Agents by Orchestration-Guided Fuzzing

**arXiv ID:** [2605.07414v1](https://arxiv.org/abs/2605.07414v1)

**作者:** Jianming Chen, Yawen Wang, Junjie Wang, Zhe Liu, Qing Wang et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07414v1.pdf)

---

## 104. Modulated learning for private and distributed regression with just a single sample per client device

**arXiv ID:** [2605.07233v1](https://arxiv.org/abs/2605.07233v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07233v1.pdf)

---

## 105. Reliable Chain-of-Thought via Prefix Consistency

**arXiv ID:** [2605.07654v1](https://arxiv.org/abs/2605.07654v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07654v1.pdf)

---

## 106. Beyond Defenses: Manifold-Aligned Regularization for Intrinsic 3D Point Cloud Robustness

**arXiv ID:** [2605.07590v1](https://arxiv.org/abs/2605.07590v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07590v1.pdf)

---

## 107. How to utilize failure demo data?: Effective data selection for imitation learning using distribution differences in attention mechanism

**arXiv ID:** [2605.07560v1](https://arxiv.org/abs/2605.07560v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07560v1.pdf)

---

## 108. Bridging the Last Mile of Circuit Design: PostEDA-Bench, a Hierarchical Benchmark for PPA Convergence and DRC Fixing

**arXiv ID:** [2605.06936v1](https://arxiv.org/abs/2605.06936v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.06936v1.pdf)

---

## 109. Safe, or Simply Incapable? Rethinking Safety Evaluation for Phone-Use Agents

**arXiv ID:** [2605.07630v1](https://arxiv.org/abs/2605.07630v1)

**作者:** Zhengyang Tang, Yi Zhang, Chenxin Li, Xin Lai, Pengyuan Lyu et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07630v1.pdf)

---

## 110. SAM 3D Animal: Promptable Animal 3D Reconstruction from Images in the Wild

**arXiv ID:** [2605.07604v1](https://arxiv.org/abs/2605.07604v1)

**作者:** Xuyi Hu, Jin Lyu, Jiuming Liu, Yebin Liu, Silvia Zuffi et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07604v1.pdf)

---

## 111. Robust stochastic first order methods in heavy-tailed noise via medoid mini-batch gradient sampling

**arXiv ID:** [2605.07634v1](https://arxiv.org/abs/2605.07634v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07634v1.pdf)

---

## 112. Intention assimilation control for accurate tracking with variable impedance in teleoperation

**arXiv ID:** [2605.07037v1](https://arxiv.org/abs/2605.07037v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07037v1.pdf)

---

## 113. The Cost of Consensus: Malignant Epistemic Herding and Adaptive Gating in Distributed Multi-Agent Search

**arXiv ID:** [2605.06988v1](https://arxiv.org/abs/2605.06988v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.06988v1.pdf)

---

## 114. Direct-to-Event Spiking Neural Network Transfer

**arXiv ID:** [2605.07207v1](https://arxiv.org/abs/2605.07207v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07207v1.pdf)
...
## 116. Switchcraft: AI Model Router for Agentic Tool Calling

**arXiv ID:** [2605.07112v1](https://arxiv.org/abs/2605.07112v1)

**作者:** Sharad Agarwal, Pooria Namyar, Alec Wolman, Rahul Ambavat, Ankur Gupta et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07112v1.pdf)

---

## 117. Beyond the Black Box: Interpretability of Agentic AI Tool Use

**arXiv ID:** [2605.06890v1](https://arxiv.org/abs/2605.06890v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.06890v1.pdf)

---

## 118. Robust Tensor Regression with Nonconvexity: Algorithmic and Statistical Theory

**arXiv ID:** [2605.07448v1](https://arxiv.org/abs/2605.07448v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07448v1.pdf)

---

## 119. When Symbol Names Should Not Matter: A Logistic Theory of Fresh-Symbol Classification

**arXiv ID:** [2605.07120v1](https://arxiv.org/abs/2605.07120v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07120v1.pdf)

---

## 120. AirBender: Adaptive Transportation of Bendable Objects Using Dual UAVs

**arXiv ID:** [2605.07003v1](https://arxiv.org/abs/2605.07003v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07003v1.pdf)

---

## 121. Parallel Lifted Planning via Semi-Naive Datalog Evaluation

**arXiv ID:** [2605.07584v1](https://arxiv.org/abs/2605.07584v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07584v1.pdf)

---

## 122. Aquatic Neuromorphic Optical Flow

**arXiv ID:** [2605.07653v1](https://arxiv.org/abs/2605.07653v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07653v1.pdf)

---

## 123. Broken-symmetry shape discrimination on a driven Duffing ring

**arXiv ID:** [2605.07475v1](https://arxiv.org/abs/2605.07475v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07475v1.pdf)

---

## 124. Graph Normalization: Fast Binarizing Dynamics for Differentiable MWIS

**arXiv ID:** [2605.05330v1](https://arxiv.org/abs/2605.05330v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.05330v1.pdf)

---

## 125. Symmetry-Protected Lyapunov Neutral Modes in Equivariant Recurrent Networks
...
## 126. MPCS: Neuroplastic Continual Learning via Multi-Component Plasticity and Topology-Aware EWC
...
## 127. Optimizing Social Utility in Sequential Experiments

**arXiv ID:** [2605.06520v1](https://arxiv.org/abs/2605.06520v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.06520v1.pdf)

---

## 128. ProteinJEPA: Latent prediction complements protein language models

**arXiv ID:** [2605.07554v1](https://arxiv.org/abs/2605.07554v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07554v1.pdf)

---

## 129. Classification Fields: Arbitrarily Fine Recursive Hierarchical Clustering From Few Examples

**arXiv ID:** [2605.07119v1](https://arxiv.org/abs/2605.07119v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07119v1.pdf)

---

## 130. DALight-3D: A Lightweight 3D U-Net for Brain Tumor Segmentation from Multi-Modal MRI
...
## 131. Nürnberg NLP at PsyDefDetect: Multi-Axis Voter Ensembles for Psychological Defence Mechanism Classification

**arXiv ID:** [2605.07606v1](https://arxiv.org/abs/2605.07606v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07606v1.pdf)

---

## 132. Finite-Time Analysis of MCTS in Continuous POMDP Planning

**arXiv ID:** [2605.07703v1](https://arxiv.org/abs/2605.07703v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07703v1.pdf)

---

## 133. Fortifying Time Series: DTW-Certified Robust Anomaly Detection

**arXiv ID:** [2605.07690v1](https://arxiv.org/abs/2605.07690v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07690v1.pdf)

---

## 134. Learning Large-Scale Modular Addition with an Auxiliary Modulus

**arXiv ID:** [2605.07648v1](https://arxiv.org/abs/2605.07648v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07648v1.pdf)

---

## 135. Optimal Recourse Summaries via Bi-Objective Decision Tree Learning

**arXiv ID:** [2605.07598v1](https://arxiv.org/abs/2605.07598v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07598v1.pdf)

---

## 136. A Refined Generalization Analysis for Extreme Multi-class Supervised Contrastive Representation Learning

**arXiv ID:** [2605.07596v1](https://arxiv.org/abs/2605.07596v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07596v1.pdf)

---

## 137. Breaking Spatial Uniformity: Prior-Guided Mamba with Radial Serialization for Lens Flare Removal

**arXiv ID:** [2605.07650v1](https://arxiv.org/abs/2605.07650v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07650v1.pdf)

---

## 138. Synchronizing Minds through Collective Predictive Coding: A Computational Model of Parent-Infant Homeostatic Co-Regulation

**arXiv ID:** [2605.07524v1](https://arxiv.org/abs/2605.07524v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07524v1.pdf)

---

## 139. Rethinking Priority Scheduling for Sequential Multi-Agent Decision Making in Stackelberg Games

**arXiv ID:** [2605.07240v1](https://arxiv.org/abs/2605.07240v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07240v1.pdf)

---

## 140. Less Random, More Private: What is the Optimal Subsampling Scheme for DP-SGD?

**arXiv ID:** [2605.07072v1](https://arxiv.org/abs/2605.07072v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07072v1.pdf)

---

## 141. Causal EpiNets: Precision-corrected Bounds on Individual Treatment Effects using Epistemic Neural Networks

**arXiv ID:** [2605.07065v1](https://arxiv.org/abs/2605.07065v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07065v1.pdf)

---

## 142. Generalising Travel Time Prediction To Varying Route Choices In Urban Networks

**arXiv ID:** [2605.06918v1](https://arxiv.org/abs/2605.06918v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.06918v1.pdf)

---

## 143. Structured Coupling for Flow Matching

**arXiv ID:** [2605.07676v1](https://arxiv.org/abs/2605.07676v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07676v1.pdf)

---

## 144. MORPH-U: Multi-Objective Resilient Motion Planning for V2X-Enabled Autonomous Driving in High-Uncertainty Environments via Simulation

**arXiv ID:** [2605.07370v1](https://arxiv.org/abs/2605.07370v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07370v1.pdf)

---

## 145. Variable Aerodynamic Damping via Co-Contraction: A Dynamic Isomorphism with Variable Stiffness Actuators

**arXiv ID:** [2605.07292v1](https://arxiv.org/abs/2605.07292v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07292v1.pdf)

---

## 146. Learning Material-Aware Hamiltonian Risk Fields for Safe Navigation

**arXiv ID:** [2605.07038v1](https://arxiv.org/abs/2605.07038v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07038v1.pdf)

---

## 147. Direct From Darwin: Deriving Advanced Optimizers From Evolutionary First Principles
...
**PDF:** [下载](http://arxiv.org/pdf/2605.05284v1.pdf)

---

## 148. phys-MCP: A Control Plane for Heterogeneous Physical Neural Networks

**arXiv ID:** [2605.04256v1](https://arxiv.org/abs/2605.04256v1)

**作者:** Stefan Fischer, Maliheh Hariri, Sebastian Otte
...
**PDF:** [下载](http://arxiv.org/pdf/2605.04256v1.pdf)

---

## 149. Unifying Dynamical Systems and Graph Theory to Mechanistically Understand Computation in Neural Networks

**arXiv ID:** [2605.03598v2](https://arxiv.org/abs/2605.03598v2)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.03598v2.pdf)

---

## 150. Cost-Ordered Feasibility for Multi-Armed Bandits with Cost Subsidy

**arXiv ID:** [2605.07171v1](https://arxiv.org/abs/2605.07171v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07171v1.pdf)
