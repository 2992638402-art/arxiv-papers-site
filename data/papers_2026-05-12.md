...
> 今日为您精选 89 篇高质量 AI/ML 论文

## 1. STARFlow2: Bridging Language Models and Normalizing Flows for Unified Multimodal Generation

**arXiv ID:** [2605.08029v1](https://arxiv.org/abs/2605.08029v1)

**作者:** Ying Shen, Tianrong Chen, Yuan Gao, Yizhe Zhang, Yuyang Wang et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.08758v1.pdf)

---

## 3. MIND-Skill: Quality-Guaranteed Skill Generation via Multi-Agent Induction and Deduction

**arXiv ID:** [2605.08670v1](https://arxiv.org/abs/2605.08670v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.08670v1.pdf)

---

## 4. Constraint-Aware Diffusion Priors for High-Fidelity and Versatile Quadruped Locomotion

**arXiv ID:** [2605.08804v1](https://arxiv.org/abs/2605.08804v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.08804v1.pdf)

---

## 5. Rubric-Grounded RL: Structured Judge Rewards for Generalizable Reasoning

**arXiv ID:** [2605.08061v1](https://arxiv.org/abs/2605.08061v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.08061v1.pdf)

---

## 6. Self-Play Enhancement via Advantage-Weighted Refinement in Online Federated LLM Fine-Tuning with Real-Time Feedback

**arXiv ID:** [2605.07977v1](https://arxiv.org/abs/2605.07977v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07977v1.pdf)

---

## 7. Preserving Foundational Capabilities in Flow-Matching VLAs through Conservative SFT

**arXiv ID:** [2605.08879v1](https://arxiv.org/abs/2605.08879v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.08879v1.pdf)

---

## 8. AgentForesight: Online Auditing for Early Failure Prediction in Multi-Agent Systems

**arXiv ID:** [2605.08715v1](https://arxiv.org/abs/2605.08715v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.08715v1.pdf)

---

## 9. Fast Byte Latent Transformer

**arXiv ID:** [2605.08044v1](https://arxiv.org/abs/2605.08044v1)

**作者:** Julie Kallini, Artidoro Pagnoni, Tomasz Limisiewicz, Gargi Ghosh, Luke Zettlemoyer et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.08044v1.pdf)

---

## 10. Towards Apples to Apples for AI Evaluations: From Real-World Use Cases to Evaluation Scenarios

**arXiv ID:** [2605.07986v1](https://arxiv.org/abs/2605.07986v1)

**作者:** Yee-Yin Choong, Kristen Greene, Alice Qian, Meryem Marasli, Ziqi Yang et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07986v1.pdf)

---

## 11. Reinforcement Learning for Exponential Utility: Algorithms and Convergence in Discounted MDPs

**arXiv ID:** [2605.08053v1](https://arxiv.org/abs/2605.08053v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.08053v1.pdf)

---

## 12. ProcVLM: Learning Procedure-Grounded Progress Rewards for Robotic Manipulation

**arXiv ID:** [2605.08774v1](https://arxiv.org/abs/2605.08774v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.08774v1.pdf)

---

## 13. IMPACT: An Implicit Active-Set Augmented Lagrangian for Fast Contact-Implicit Trajectory Optimization

**arXiv ID:** [2605.09127v1](https://arxiv.org/abs/2605.09127v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.09127v1.pdf)

---

## 14. VECTOR-Drive: Tightly Coupled Vision-Language and Trajectory Expert Routing for End-to-End Autonomous Driving

**arXiv ID:** [2605.08830v1](https://arxiv.org/abs/2605.08830v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.08830v1.pdf)

---

## 15. Large Language Models over Networks: Collaborative Intelligence under Resource Constraints

**arXiv ID:** [2605.08626v1](https://arxiv.org/abs/2605.08626v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.08626v1.pdf)
...
**作者:** Jiayuan Liu, Tianqin Li, Shiyi Du, Xin Luo, Haoxuan Zeng et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.08060v1.pdf)

---

## 17. Tool Calling is Linearly Readable and Steerable in Language Models

**arXiv ID:** [2605.07990v1](https://arxiv.org/abs/2605.07990v1)

**作者:** Zekun Wu, Ze Wang, Seonglae Cho, Yufei Yang, Adriano Koshiyama et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07990v1.pdf)

---

## 18. RigidFormer: Learning Rigid Dynamics using Transformers

**arXiv ID:** [2605.09196v1](https://arxiv.org/abs/2605.09196v1)

**作者:** Zhiyang Dou, Minghao Guo, Haixu Wu, Doug Roble, Tuur Stuyck et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.09196v1.pdf)

---

## 19. Towards Backdoor-Based Ownership Verification for Vision-Language-Action Models

**arXiv ID:** [2605.09005v1](https://arxiv.org/abs/2605.09005v1)

**作者:** Ming Sun, Rui Wang, Xingrui Yu, Lihua Jing, Hangyu Du et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.09005v1.pdf)

---

## 20. Robust Multi-Agent LLMs under Byzantine Faults

**arXiv ID:** [2605.09076v1](https://arxiv.org/abs/2605.09076v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.09076v1.pdf)

---

## 21. Flow-OPD: On-Policy Distillation for Flow Matching Models

**arXiv ID:** [2605.08063v1](https://arxiv.org/abs/2605.08063v1)

**作者:** Zhen Fang, Wenxuan Huang, Yu Zeng, Yiming Zhao, Shuang Chen et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.08043v1.pdf)

---

## 23. Graph-Structured Hyperdimensional Computing for Data-Efficient and Explainable Process-Structure-Property Prediction

**arXiv ID:** [2605.07999v1](https://arxiv.org/abs/2605.07999v1)

**作者:** Jingzhan Ge, Ajeeth Vellore, Ajinkya Palwe, Ahsan Khan, David Gorsich et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07999v1.pdf)

---

## 24. Exploring the non-convexity in machine learning using quantum-inspired optimization

**arXiv ID:** [2605.07947v1](https://arxiv.org/abs/2605.07947v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07947v1.pdf)

---

## 25. Penalty-Based First-Order Methods for Bilevel Optimization with Minimax and Constrained Lower-Level Problems

**arXiv ID:** [2605.08006v1](https://arxiv.org/abs/2605.08006v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.08006v1.pdf)

---

## 26. REAP: Reinforcement-Learning End-to-End Autonomous Parking with Gaussian Splatting Simulator for Real2Sim2Real Transfer

**arXiv ID:** [2605.08713v1](https://arxiv.org/abs/2605.08713v1)

**作者:** Changze Li, Zhe Chen, Shaoyu Chen, Lisen Mu, Yijian Li et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.08713v1.pdf)

---

## 27. MCP-Cosmos: World Model-Augmented Agents for Complex Task Execution in MCP Environments

**arXiv ID:** [2605.09131v1](https://arxiv.org/abs/2605.09131v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.09131v1.pdf)

---

## 28. Learning to Communicate Locally for Large-Scale Multi-Agent Pathfinding
...
## 29. Latent Geometry Beyond Search: Amortizing Planning in World Models

**arXiv ID:** [2605.08732v1](https://arxiv.org/abs/2605.08732v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.08732v1.pdf)

---

## 30. Interpreting Reinforcement Learning Agents with Susceptibilities

**arXiv ID:** [2605.08007v1](https://arxiv.org/abs/2605.08007v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.08007v1.pdf)

---

## 31. EmambaIR: Efficient Visual State Space Model for Event-guided Image Reconstruction
...
**PDF:** [下载](http://arxiv.org/pdf/2605.08073v1.pdf)

---

## 32. Beyond Pairs: Your Language Model is Secretly Optimizing a Preference Graph

**arXiv ID:** [2605.08037v1](https://arxiv.org/abs/2605.08037v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.08037v1.pdf)

---

## 33. Abductive Reasoning with Probabilistic Commonsense

**arXiv ID:** [2605.08011v1](https://arxiv.org/abs/2605.08011v1)

**作者:** Joseph Cotnareanu, Chiara Roverato, Han Zhou, Didier Chetelat, Yingxue Zhang et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.08011v1.pdf)

---

## 34. Dooly: Configuration-Agnostic, Redundancy-Aware Profiling for LLM Inference Simulation

**arXiv ID:** [2605.07985v1](https://arxiv.org/abs/2605.07985v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07985v1.pdf)

---

## 35. It Just Takes Two: Scaling Amortized Inference to Large Sets

**arXiv ID:** [2605.07972v1](https://arxiv.org/abs/2605.07972v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07972v1.pdf)

---

## 36. Automated Robotic Moisture Monitoring in Agricultural Fields

**arXiv ID:** [2605.09050v1](https://arxiv.org/abs/2605.09050v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.09050v1.pdf)

---

## 37. Geometry Guided Self-Consistency for Physical AI

**arXiv ID:** [2605.08638v1](https://arxiv.org/abs/2605.08638v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.08638v1.pdf)

---

## 38. Not All Turns Matter: Credit Assignment for Multi-Turn Jailbreaking

**arXiv ID:** [2605.08778v1](https://arxiv.org/abs/2605.08778v1)

**作者:** Zhida He, Xiaoyu Wen, Han Qi, Ziyuan Zhou, Peng Yu et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.08778v1.pdf)

---

## 39. Beyond the All-in-One Agent: Benchmarking Role-Specialized Multi-Agent Collaboration in Enterprise Workflows

**arXiv ID:** [2605.08761v1](https://arxiv.org/abs/2605.08761v1)

**作者:** Tao Yu, Hao Wang, Changyu Li, Shenghua Chai, Minghui Zhang et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.08761v1.pdf)

---

## 40. LLM Wardens: Mitigating Adversarial Persuasion with Third-Party Conversational Oversight

**arXiv ID:** [2605.08321v1](https://arxiv.org/abs/2605.08321v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.08321v1.pdf)

---

## 41. A low-cost mockup to simulate robotic laser cutting in nuclear decommissioning

**arXiv ID:** [2605.08947v1](https://arxiv.org/abs/2605.08947v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.08947v1.pdf)

---

## 42. Reason to Play: Behavioral and Brain Alignment Between Frontier LRMs and Human Game Learners

**arXiv ID:** [2605.08019v1](https://arxiv.org/abs/2605.08019v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.08019v1.pdf)

---

## 43. Normalizing Trajectory Models

**arXiv ID:** [2605.08078v1](https://arxiv.org/abs/2605.08078v1)

**作者:** Jiatao Gu, Tianrong Chen, Ying Shen, David Berthelot, Shuangfei Zhai et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.08078v1.pdf)

---

## 44. Semiparametric Efficient Test for Interpretable Distributional Treatment Effects

**arXiv ID:** [2605.08034v1](https://arxiv.org/abs/2605.08034v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.08034v1.pdf)

---

## 45. Beyond Self-Play: Hierarchical Reasoning for Continuous Motion in Closed-Loop Traffic Simulation

**arXiv ID:** [2605.09153v1](https://arxiv.org/abs/2605.09153v1)

**作者:** Weifan Zhang, Xiaofeng Zhao, Adel Bazzi, Mingrui Li, Yifan Wei et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.09153v1.pdf)

---

## 46. ElasticFlow: One-Step Physics-Consistent Policy with Elastic Time Horizons for Language-Guided Manipulation

**arXiv ID:** [2605.08799v1](https://arxiv.org/abs/2605.08799v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.08799v1.pdf)

---

## 47. VecCISC: Improving Confidence-Informed Self-Consistency with Reasoning Trace Clustering and Candidate Answer Selection
...
**PDF:** [下载](http://arxiv.org/pdf/2605.08070v1.pdf)

---

## 48. TimeLesSeg: Unified Contrast-Agnostic Cross-Sectional and Longitudinal MS Lesion Segmentation via a Stochastic Generative Model

**arXiv ID:** [2605.07955v1](https://arxiv.org/abs/2605.07955v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07955v1.pdf)

---

## 49. PET-Adapter: Test-Time Domain Adaptation for Full and Limited-Angle PET Image Reconstruction

**arXiv ID:** [2605.08030v1](https://arxiv.org/abs/2605.08030v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.08030v1.pdf)

---

## 50. HyDRA Scorpion: A Cost-effective and Modular ROV for Real-Time Underwater Inspection, Intervention, and Object Detection

**arXiv ID:** [2605.09093v1](https://arxiv.org/abs/2605.09093v1)

**作者:** Anika Tabassum Orchi, Md Farhan Zaman, Md Darain Khan, Md Alamgir, Mahbubul Islam et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.09093v1.pdf)

---

## 51. Generalization Bounds of Emergent Communications for Agentic AI Networking

**arXiv ID:** [2605.08613v1](https://arxiv.org/abs/2605.08613v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.08613v1.pdf)

---

## 52. Slipstream: Trajectory-Grounded Compaction Validation for Long-Horizon Agents

**arXiv ID:** [2605.08580v1](https://arxiv.org/abs/2605.08580v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.08580v1.pdf)

---

## 53. SceneFactory: GPU-Accelerated Multi-Agent Driving Simulation with Physics-Based Vehicle Dynamics

**arXiv ID:** [2605.08528v1](https://arxiv.org/abs/2605.08528v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.08528v1.pdf)

---

## 54. TraceFix: Repairing Agent Coordination Protocols with TLA+ Counterexamples

**arXiv ID:** [2605.07935v1](https://arxiv.org/abs/2605.07935v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07935v1.pdf)

---

## 55. Many-to-Many Multi-Agent Pickup and Delivery

**arXiv ID:** [2605.07835v1](https://arxiv.org/abs/2605.07835v1)

**作者:** Ethan Schneider, Jingkai Chen, Tianyi Gu, Kunlei Lian, Seth Hutchinson et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07835v1.pdf)

---

## 56. Don't Get Your Kroneckers in a Twist: Gaussian Processes on High-Dimensional Incomplete Grids

**arXiv ID:** [2605.08036v1](https://arxiv.org/abs/2605.08036v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.08036v1.pdf)

---

## 57. Octopus Protocol: One-Shot Hardware Discovery and Control for AI Agents via Infrastructure-as-Prompts

**arXiv ID:** [2605.09055v1](https://arxiv.org/abs/2605.09055v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.09055v1.pdf)

---

## 58. Terminal Matters: Kinodynamic Planning with a Terminal Cost and Learned Uncertainty in Belief State-Cost Space

**arXiv ID:** [2605.09046v1](https://arxiv.org/abs/2605.09046v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.09046v1.pdf)

---

## 59. HULK: Large-scale Hierarchical Coordination under Continual and Uncertain Temporal Tasks

**arXiv ID:** [2605.08722v1](https://arxiv.org/abs/2605.08722v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.08722v1.pdf)

---

## 60. Internal vs. External: Comparing Deliberation and Evolution for Multi-Agent Constitutional Design

**arXiv ID:** [2605.09128v1](https://arxiv.org/abs/2605.09128v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.09128v1.pdf)

---

## 61. Too Many Specialists: Emergent Inefficiencies and Bottlenecks for Multi-agent Ad-hoc Collaboration

**arXiv ID:** [2605.08540v1](https://arxiv.org/abs/2605.08540v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.08540v1.pdf)

---

## 62. Raymoval: Raycasting-based Dynamic Object Removal for Static 3D Mapping

**arXiv ID:** [2605.08937v1](https://arxiv.org/abs/2605.08937v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.08937v1.pdf)

---

## 63. A Visuo-Tactile Data Collection System with Haptic Feedback for Coarse-to-Fine Imitation Learning

**arXiv ID:** [2605.08757v1](https://arxiv.org/abs/2605.08757v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.08757v1.pdf)

---

## 64. Smoothing Out the Edges: Continuous-Time Estimation with Gaussian Process Motion Priors on Factor Graphs

**arXiv ID:** [2605.09073v1](https://arxiv.org/abs/2605.09073v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.09073v1.pdf)

---

## 65. CA-SQL: Complexity-Aware Inference Time Reasoning for Text-to-SQL via Exploration and Compute Budget Allocation
...
**PDF:** [下载](http://arxiv.org/pdf/2605.08057v1.pdf)

---

## 66. Learning CLI Agents with Structured Action Credit under Selective Observation

**arXiv ID:** [2605.08013v1](https://arxiv.org/abs/2605.08013v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.08013v1.pdf)

---

## 67. Where's the Plan? Locating Latent Planning in Language Models with Lightweight Mechanistic Interventions

**arXiv ID:** [2605.07984v1](https://arxiv.org/abs/2605.07984v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07984v1.pdf)

---

## 68. GRAPHLCP: Structure-Aware Localized Conformal Prediction on Graphs

**arXiv ID:** [2605.08074v1](https://arxiv.org/abs/2605.08074v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.08074v1.pdf)

---

## 69. PropSplat: Map-Free RF Field Reconstruction via 3D Gaussian Propagation Splatting

**arXiv ID:** [2605.08035v1](https://arxiv.org/abs/2605.08035v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.08035v1.pdf)

---

## 70. Bayesian Sensitivity of Causal Inference Estimators under Evidence-Based Priors

**arXiv ID:** [2605.07993v1](https://arxiv.org/abs/2605.07993v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07993v1.pdf)

---

## 71. VISTA: A Benchmark for Real-Time Video Streaming under Network Impairments in Surgical Teleoperation

**arXiv ID:** [2605.08886v1](https://arxiv.org/abs/2605.08886v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.08886v1.pdf)

---

## 72. AssemPlanner: A Multi-Agent Based Task Planning Framework for Flexible Assembly System

**arXiv ID:** [2605.08831v1](https://arxiv.org/abs/2605.08831v1)

**作者:** Chenhao Zhang, Chaoran Zhang, Zhaobo Xu, Yongbo Yang, Pingfa Feng et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2605.08831v1.pdf)

---

## 73. Modeling Decision-Making with Will for Cooperation in Social Dilemmas

**arXiv ID:** [2605.08669v1](https://arxiv.org/abs/2605.08669v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.08669v1.pdf)

---

## 74. TAVIS: A Benchmark for Egocentric Active Vision and Anticipatory Gaze in Imitation Learning

**arXiv ID:** [2605.07943v1](https://arxiv.org/abs/2605.07943v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07943v1.pdf)

---

## 75. Adaptive Domain Decomposition Physics-Informed Neural Networks for Traffic State Estimation with Sparse Sensor Data

**arXiv ID:** [2605.08028v1](https://arxiv.org/abs/2605.08028v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.08028v1.pdf)

---

## 76. STEPS: A Temporal Smooth Error Propagation Solver on the Manifolds for Test-Time Adaptation in Time Series Forecasting

**arXiv ID:** [2605.08005v1](https://arxiv.org/abs/2605.08005v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.08005v1.pdf)

---

## 77. Globally Optimal Training of Spiking Neural Networks via Parameter Reconstruction

**arXiv ID:** [2605.08022v1](https://arxiv.org/abs/2605.08022v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.08022v1.pdf)

---

## 78. SHIELD: Scalable Optimal Control with Certification using Duality and Convexity

**arXiv ID:** [2605.09171v1](https://arxiv.org/abs/2605.09171v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.09171v1.pdf)

---

## 79. The Limits of AI-Driven Allocation: Optimal Screening under Aleatoric Uncertainty

**arXiv ID:** [2605.07979v1](https://arxiv.org/abs/2605.07979v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07979v1.pdf)

---

## 80. Communicating Sound Through Natural Language

**arXiv ID:** [2605.08750v1](https://arxiv.org/abs/2605.08750v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.08750v1.pdf)

---

## 81. Nash without Numbers: A Social Choice Approach to Mixed Equilibria in Context-Ordinal Games

**arXiv ID:** [2605.07996v1](https://arxiv.org/abs/2605.07996v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07996v1.pdf)

---

## 82. Synchronizing Minds through Collective Predictive Coding: A Computational Model of Parent-Infant Homeostatic Co-Regulation
...
## 83. MPD$^2$-Router: Mask-aware Multi-expert Prior-regularized Dual-head Deferral Router in Glaucoma Screening and Diagnosis

**arXiv ID:** [2605.08024v1](https://arxiv.org/abs/2605.08024v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.08024v1.pdf)

---

## 84. A Note on Non-Negative $L_1$-Approximating Polynomials

**arXiv ID:** [2605.08072v1](https://arxiv.org/abs/2605.08072v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.08072v1.pdf)

---

## 85. Emergence of Social Reality of Emotion through a Social Allostasis Model with Dynamic Interpretants

**arXiv ID:** [2605.07761v1](https://arxiv.org/abs/2605.07761v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07761v1.pdf)

---

## 86. Zero-Shot Imagined Speech Decoding via Imagined-to-Listened MEG Mapping

**arXiv ID:** [2605.08075v1](https://arxiv.org/abs/2605.08075v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.08075v1.pdf)

---

## 87. Susceptibilities and Patterning: A Primer on Linear Response in Bayesian Learning

**arXiv ID:** [2605.07980v1](https://arxiv.org/abs/2605.07980v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07980v1.pdf)

---

## 88. The Endogeneity of Miscalibration: Impossibility and Escape in Scored Reporting

**arXiv ID:** [2605.07671v1](https://arxiv.org/abs/2605.07671v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2605.07671v1.pdf)

---

## 89. Position: Mechanistic Interpretability Must Disclose Identification Assumptions for Causal Claims
...
**PDF:** [下载](http://arxiv.org/pdf/2605.08012v1.pdf)
