# arXiv 每日精选 - 2026-07-23

> 今日为您精选 83 篇高质量 AI/ML 论文
...
**PDF:** [下载](http://arxiv.org/pdf/2607.19344v1.pdf)
...
**PDF:** [下载](http://arxiv.org/pdf/2607.20284v1.pdf)
...
## 6. SHFormer: Dynamic Spectral Filtering Convolutional Neural Network and High-pass Kernel Generation Transformer for Adaptive MRI Reconstruction

**arXiv ID:** [2607.20159v1](https://arxiv.org/abs/2607.20159v1)

**作者:** Sriprabha Ramanarayanan, Rahul G. S., Mohammad Al Fahim, Keerthi Ram, Ramesh Venkatesan et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2607.20159v1.pdf)

---

## 7. Computational Humor with Multimodal LLMs: Methods, Datasets, Evaluation, and Challenges
...
**PDF:** [下载](http://arxiv.org/pdf/2607.19011v1.pdf)

---

## 8. ISO: An RLVR-Native Optimization Stack

**arXiv ID:** [2607.19331v1](https://arxiv.org/abs/2607.19331v1)

**作者:** Hanqing Zhu, Wenyan Cong, Zhizhou Sha, Sagnik Mukherjee, Xinyuan Song et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2607.19331v1.pdf)

---

## 9. StreamHOI: Interaction-aware Temporal Memory Adaptation for Streaming HOI Video Generation
...
**PDF:** [下载](http://arxiv.org/pdf/2607.20174v1.pdf)

---

## 10. Two-Level Meta-Rubrics for Evaluating Open-Ended Generation: GAMUT, a Benchmark for Factual Completeness

**arXiv ID:** [2607.19322v1](https://arxiv.org/abs/2607.19322v1)

**作者:** Xilun Chen, Zhaleh Feizollahi, Ross Goodwin, Seungwhan Moon, Scott Yih et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2607.19322v1.pdf)

---

## 11. HeadCast: Casting Attention Heads for Efficient Autoregressive Video Generation

**arXiv ID:** [2607.20125v1](https://arxiv.org/abs/2607.20125v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2607.20125v1.pdf)

---

## 12. AdaFlash: Adaptive Speculative Decoding via On-Policy Distilled Diffusion Drafters

**arXiv ID:** [2607.19223v1](https://arxiv.org/abs/2607.19223v1)

**作者:** Yu-Yang Qian, Hao-Cong Wu, Chen Chen, Jiacheng Sun, Zhenhua Dong et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2607.19223v1.pdf)

---

## 13. Evolving Cache Schedules for Fast Diffusion Policy Inference

**arXiv ID:** [2607.20293v1](https://arxiv.org/abs/2607.20293v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2607.20293v1.pdf)

---

## 14. ENTRAP-VL: A Taxonomic Probe for Dual Contextual Entrainment in Vision-Language Models
...
**PDF:** [下载](http://arxiv.org/pdf/2607.20092v1.pdf)

---

## 15. Conservative Query and Adaptive Regularization for Offline RL Under Uncertainty Estimation

**arXiv ID:** [2607.19199v1](https://arxiv.org/abs/2607.19199v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2607.19199v1.pdf)
...
**PDF:** [下载](http://arxiv.org/pdf/2607.19261v1.pdf)
...
## 19. ABot-World-0: Infinite Interactive World Rollout on a Single Desktop GPU
...
## 20. Vera: Identity-Faithful Human Subject-to-Video Generation
...
**PDF:** [下载](http://arxiv.org/pdf/2607.20247v1.pdf)

---

## 21. PerceptDrive: Perception Prior World-Action Modeling with Adaptive Expert Routing for End-to-End Autonomous Driving

**arXiv ID:** [2607.20175v1](https://arxiv.org/abs/2607.20175v1)

**作者:** Yushan Liu, Tianxiong Lv, Bohua Wang, Hangqi Fan, Chenxu Zhao et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2607.20175v1.pdf)

---

## 22. Provable diffusion-based posterior sampling for linear inverse problems via DDIM

**arXiv ID:** [2607.19333v1](https://arxiv.org/abs/2607.19333v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2607.19333v1.pdf)

---

## 23. AutoJourn: Multi-Perspective Summarisation, Bias Detection and Bias Neutralisation for LLM-Generated News in Automated Journalism

**arXiv ID:** [2607.18983v1](https://arxiv.org/abs/2607.18983v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2607.18983v1.pdf)

---

## 24. ROMS-IMLE: A Minimalist Approach to Competitive Single-Step Generative Modelling

**arXiv ID:** [2607.19332v1](https://arxiv.org/abs/2607.19332v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2607.19332v1.pdf)
...
## 26. ATLAS: A Foundation Neural Sampler for Amorphous Materials

**arXiv ID:** [2607.19198v1](https://arxiv.org/abs/2607.19198v1)

**作者:** Mouyang Cheng, Denis Blessing, Botao Yu, Gerhard Neumann, Mingda Li et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2607.19198v1.pdf)

---

## 27. PercepCap: Video Captioner with Structured Spatio-Temporal Perception

**arXiv ID:** [2607.20389v1](https://arxiv.org/abs/2607.20389v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2607.20389v1.pdf)

---

## 28. Inference-Time Steering for Cross-Lingual Factual Consistency in LLMs

**arXiv ID:** [2607.19243v1](https://arxiv.org/abs/2607.19243v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2607.19243v1.pdf)

---

## 29. Off-Context GRPO: Learning to Reason on Hard Problems using Privileged Information

**arXiv ID:** [2607.19313v1](https://arxiv.org/abs/2607.19313v1)

**作者:** Priyank Agrawal, Ankur Samanta, Shervin Ghasemlou, Jalaj Bhandari, Kavosh Asadi et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2607.19313v1.pdf)

---

## 30. DBMol: Design of High-Affinity, Target-Specific Small Molecules through Structure Prediction Models

**arXiv ID:** [2607.19237v1](https://arxiv.org/abs/2607.19237v1)

**作者:** Yiming Qin, Kai Yi, Miruna Cretu, Sjors H. W. Scheres, Pietro Liò et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2607.19237v1.pdf)
...
## 32. Self Gradient Forcing: Native Long Video Extrapolation
...
**PDF:** [下载](http://arxiv.org/pdf/2607.20368v1.pdf)

---

## 33. Diverse-Intent Multi-Turn Fashion Image Retrieval

**arXiv ID:** [2607.20291v1](https://arxiv.org/abs/2607.20291v1)

**作者:** Mingqiang Tang, Haokun Wen, Meng Liu, Yupeng Hu, Weili Guan et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2607.20291v1.pdf)

---

## 34. RS-RIE-Bench: Benchmarking Reasoning-Guided Remote Sensing Image Editing

**arXiv ID:** [2607.20197v1](https://arxiv.org/abs/2607.20197v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2607.20197v1.pdf)

---

## 35. Development of an automated, reliable, and clinically meaningful artificial intelligence (AI) tool for diagnosing cardiac disease from conventional cardiovascular magnetic resonance (CMR) images

**arXiv ID:** [2607.20087v1](https://arxiv.org/abs/2607.20087v1)

**作者:** Sina Amirrajab, Volker Vehof, Michael Bietenbeck, Nuriye Akyol, Redouane Bouras et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2607.20087v1.pdf)

---

## 36. GaussianSeed: Hierarchical Gaussian Seeding for High-Resolution 3D Occupancy Prediction

**arXiv ID:** [2607.20071v1](https://arxiv.org/abs/2607.20071v1)

**作者:** Xinzhuo Li, Xianghui Pan, Jiayuan Du, Wei Wei, Liuyi Wang et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2607.20071v1.pdf)

---

## 37. LLM Detection as an Intervention: Downstream Impact under Strategic User Behavior

**arXiv ID:** [2607.19300v1](https://arxiv.org/abs/2607.19300v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2607.19300v1.pdf)

---

## 38. Agents in the Wild: Where Research Meets Deployment

**arXiv ID:** [2607.19336v1](https://arxiv.org/abs/2607.19336v1)

**作者:** Grace Hui Yang, Pranav N. Venkit, Hooman Sedghamiz, Enrico Santus, Victor Dibia et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2607.19336v1.pdf)

---

## 39. From Distances to Trajectories: Real-Time Signed Distance Function Mapping and Distance-Accelerated Motion Planning for UAVs

**arXiv ID:** [2607.19306v1](https://arxiv.org/abs/2607.19306v1)

**作者:** Jason Stanley, Zhirui Dai, Qihao Qian, Tzu-Chin Ho, Tianxing Fan et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2607.19306v1.pdf)

---

## 40. BioSecBench-Surveillance: A Verifiable Benchmark for AI Agents in Pathogen Genomic Surveillance

**arXiv ID:** [2607.19262v1](https://arxiv.org/abs/2607.19262v1)

**作者:** Harmon Bhasin, Kevin Flyangolts, Dianzhuo Wang, Evan Seeyave, Arjun Banerjee et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2607.19262v1.pdf)

---

## 41. Benchmarking Generalization in Financial Statement Fraud Detection: robust evaluation and novel tasks

**arXiv ID:** [2607.19259v1](https://arxiv.org/abs/2607.19259v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2607.19259v1.pdf)

---

## 42. A Reinforcement-Learning-Augmented Liquid-Fueled Reactor Network Model for Predicting Lean Blowout in Gas Turbine Combustors

**arXiv ID:** [2607.19281v1](https://arxiv.org/abs/2607.19281v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2607.19281v1.pdf)
...
## 44. MedDDC-Eval: Diagnosis-Decoupled Evaluation of Multi-Turn Medical Consultation Agents

**arXiv ID:** [2607.18999v1](https://arxiv.org/abs/2607.18999v1)

**作者:** Guofeng Zhang, Yizeng Quan, Huaiyi Fang, Jianwei Lv, Jinyao Liu et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2607.18999v1.pdf)

---

## 45. Test-Time Training for Modality Order Consistency in Vision-Language Models
...
**PDF:** [下载](http://arxiv.org/pdf/2607.20351v1.pdf)

---

## 46. Importance-Aware OBS Pruning for Diffusion Models
...
**PDF:** [下载](http://arxiv.org/pdf/2607.20048v1.pdf)

---

## 47. Graph-Based Agentic AI with LangGraph: Workflow Pathways for Long-Running Stateful Business Processes

**arXiv ID:** [2607.19297v1](https://arxiv.org/abs/2607.19297v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2607.19297v1.pdf)

---

## 48. GUIDED Network-Agnostic Feature Initialization for Spatial Transferability in GNN-based Models

**arXiv ID:** [2607.19270v1](https://arxiv.org/abs/2607.19270v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2607.19270v1.pdf)

---

## 49. CodeRescue: Budget-Calibrated Recovery Routing for Coding Agents

**arXiv ID:** [2607.19338v1](https://arxiv.org/abs/2607.19338v1)

**作者:** Qijia He, Jiayi Cheng, Chenqian Le, Rui Wang, Xunmei Liu et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2607.19338v1.pdf)

---

## 50. Associative Emotional Learning in Convolutional Neural Networks

**arXiv ID:** [2607.19327v1](https://arxiv.org/abs/2607.19327v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2607.19327v1.pdf)

---

## 51. ResearchArena: Evaluating Sabotage and Monitoring in Automated AI R&amp;D

**arXiv ID:** [2607.19321v1](https://arxiv.org/abs/2607.19321v1)

**作者:** Lena Libon, Ben Rank, Jehyeok Yeon, David Schmotz, Jeremy Qin et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2607.19321v1.pdf)

---

## 52. Staypoint Detection from Noisy Trajectory Data [Experiment Paper]

**arXiv ID:** [2607.19312v1](https://arxiv.org/abs/2607.19312v1)

**作者:** Lance Kennedy, Hossein Amiri, Yueyang Liu, Riyang Bao, Hanqi Chen et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2607.19312v1.pdf)

---

## 53. Real-time optimal control with shallow recurrent decoder networks

**arXiv ID:** [2607.19302v1](https://arxiv.org/abs/2607.19302v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2607.19302v1.pdf)

---

## 54. Thermodynamics-Informed Input Reparameterization for Neural Prediction of Real-Fluid Thermodynamic Properties in Supercritical Combustion

**arXiv ID:** [2607.19241v1](https://arxiv.org/abs/2607.19241v1)

**作者:** Haoze Zhang, Han Li, Ke Xiao, Yangchen Xu, Runze Mao et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2607.19241v1.pdf)

---

## 55. RIM: A Retrieval-In-Matching Framework for Cross-Domain Global Visual Localization of UAVs

**arXiv ID:** [2607.20116v1](https://arxiv.org/abs/2607.20116v1)

**作者:** Xin Li, Siyuan Duan, Shang Wang, Zhimin Mao, Bingliang Hu et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2607.20116v1.pdf)

---

## 56. MIRA-Ev:A Benchmark for Granular Evidence Detection and Relational Reasoning in Clinical Exams
...
## 57. Prompt Design at Scale: How Format, Instruction Count, and Context Length Shape Instruction Adherence and Hallucination in Large Language Models

**arXiv ID:** [2607.19257v1](https://arxiv.org/abs/2607.19257v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2607.19257v1.pdf)

---

## 58. The safety failures we are not instrumenting: a perspective on hidden safety-critical challenges in modern AI systems

**arXiv ID:** [2607.19292v1](https://arxiv.org/abs/2607.19292v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2607.19292v1.pdf)

---

## 59. Sequential Learner Modeling Using Multi-Relational Graph Convolutional Networks

**arXiv ID:** [2607.19253v1](https://arxiv.org/abs/2607.19253v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2607.19253v1.pdf)

---

## 60. 1-Lipschitz Neural Networks on Hadamard Manifolds

**arXiv ID:** [2607.19335v1](https://arxiv.org/abs/2607.19335v1)

**作者:** Davide Murari, Marta Ghirardelli, Ben Adcock, Elena Celledoni, Brynjulf Owren et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2607.19335v1.pdf)

---

## 61. Automated Extraction of Techno-Economic Data from 76,000 Energy System Studies

**arXiv ID:** [2607.19178v1](https://arxiv.org/abs/2607.19178v1)

**作者:** Maxime Gorres, Jan Göpfert, Patrick Kuckertz, Noor Titan Putri Hartono, Heidi Heinrichs et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2607.19178v1.pdf)

---

## 62. DAIS: Dependency-Aware Intermediate QA Supervision for Complex Reasoning
...
## 63. Content is What Remains: Invariant Speech Tokenization from Parallel Utterances

**arXiv ID:** [2607.19033v1](https://arxiv.org/abs/2607.19033v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2607.19033v1.pdf)

---

## 64. Persian Pixel: A large-scale synthetic OCR dataset for Persian language
...
**PDF:** [下载](http://arxiv.org/pdf/2607.20385v1.pdf)

---

## 65. Toward Reliable RGB-D Semantic Segmentation: Handling Missing Modalities via Condition Dropout

**arXiv ID:** [2607.20326v1](https://arxiv.org/abs/2607.20326v1)

**作者:** Xuchen Zhu, Yajuan Wei, Shuang Hao, Jiwei Jiang, Guanxiang Mao et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2607.20326v1.pdf)

---

## 66. Self-supervision drives representational convergence in medical foundation models more than clinical supervision

**arXiv ID:** [2607.20274v1](https://arxiv.org/abs/2607.20274v1)

**作者:** Soroosh Tayebi Arasteh, Sebastian Ziegelmayer, Mahshad Lotfinia, Lisa Adams, Sven Nebelung et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2607.20274v1.pdf)

---

## 67. How Does Urban Context Relate to Residential Building Health? A Vision-POI Fusion Framework for Building-Level Housing Inspection

**arXiv ID:** [2607.20263v1](https://arxiv.org/abs/2607.20263v1)

**作者:** Kun Zhao, Helei Ren, Guilin Tang, Tianyi Chen, Zhehui Song et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2607.20263v1.pdf)

---

## 68. Not All Patches are Equal: Sampling Matters for Visible-Infrared Pre-Training

**arXiv ID:** [2607.20238v1](https://arxiv.org/abs/2607.20238v1)

**作者:** Qiwei Ma, Bin Deng, Junjie Zhu, Qiangjuan Huang, Puhong Duan et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2607.20238v1.pdf)

---

## 69. Factor-Informed Uncertainty Distillation for Gaze Estimation

**arXiv ID:** [2607.20072v1](https://arxiv.org/abs/2607.20072v1)

**作者:** Mohammadreza Jamalifard, Yaxiong Lei, Javier Fumanal Idocin, Parastoo Azizinezhad, Tom Foulsham et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2607.20072v1.pdf)

---

## 70. Riemannian Deep Learning:Modules, Networks, and Geometries

**arXiv ID:** [2607.19305v1](https://arxiv.org/abs/2607.19305v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2607.19305v1.pdf)

---

## 71. They'll Verify. They Just Won't Act. How Authority Framing and Laundered Code Turn a Trusted Agentic CI/CD Pipeline Into an Attack Surface
...
## 72. Translation as Augmentation: Effect of Translated Data on Assessment of Difficulty

**arXiv ID:** [2607.19101v1](https://arxiv.org/abs/2607.19101v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2607.19101v1.pdf)

---

## 73. Fundamental limits of distributed multiclass classification from simple binary decisions

**arXiv ID:** [2607.19334v1](https://arxiv.org/abs/2607.19334v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2607.19334v1.pdf)

---

## 74. CircuitKIT : Circuit Discovery, Evaluation, and Application Toolkit for Mechanistic Interpretability
...
**PDF:** [下载](http://arxiv.org/pdf/2607.19317v1.pdf)

---

## 75. In-Context Time Series Classification with Random Convolutional Features

**arXiv ID:** [2607.19234v1](https://arxiv.org/abs/2607.19234v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2607.19234v1.pdf)

---

## 76. Selective State-Space Adaptation and Retrieval for Language Model Reasoning

**arXiv ID:** [2607.19326v1](https://arxiv.org/abs/2607.19326v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2607.19326v1.pdf)

---

## 77. Benchmarking Human and Automatic Speech Recognition of Diverse Speech: Initial Results

**arXiv ID:** [2607.19049v1](https://arxiv.org/abs/2607.19049v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2607.19049v1.pdf)

---

## 78. Disentangling Curriculum Learning in NLP: Towards a Unifying Taxonomy

**arXiv ID:** [2607.18984v1](https://arxiv.org/abs/2607.18984v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2607.18984v1.pdf)

---

## 79. Verifiable Self-Evolution for Open-Ended Dialogue Skills via Future-Feedback Prediction

**arXiv ID:** [2607.18973v1](https://arxiv.org/abs/2607.18973v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2607.18973v1.pdf)

---

## 80. Toward Auditable Fraud Detection: Combining Graph Features, Model Explanations, and Agentic Case Investigation

**arXiv ID:** [2607.19266v1](https://arxiv.org/abs/2607.19266v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2607.19266v1.pdf)

---

## 81. Selection Shapes the Boundary: A Preregistered Replication of Monotonicity and Label Agreement in Unselected NLI Populations

**arXiv ID:** [2607.19231v1](https://arxiv.org/abs/2607.19231v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2607.19231v1.pdf)

---

## 82. Real-Time EEG Cap Electrode Detection for Guided Point-of-Care Placement

**arXiv ID:** [2607.20142v1](https://arxiv.org/abs/2607.20142v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2607.20142v1.pdf)

---

## 83. Supra Cognitive Modes: A Routed Architecture for Agent Memory

**arXiv ID:** [2607.19096v1](https://arxiv.org/abs/2607.19096v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2607.19096v1.pdf)
