...
**PDF:** [下载](http://arxiv.org/pdf/2609.23257v1.pdf)

---

## 2. Lifted Bellman Linear Programming for Offline Reinforcement Learning

**arXiv ID:** [2609.24489v1](https://arxiv.org/abs/2609.24489v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2609.24489v1.pdf)

---

## 3. SparkDiffusion: Mitigating the High-Sparsity Trap --- A Unified Framework for up to $265\times$ Single-GPU Acceleration of Visual Generation

**arXiv ID:** [2609.23153v1](https://arxiv.org/abs/2609.23153v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2609.23153v1.pdf)

---

## 4. DiagGen: Agentic Generation of Deformable Assets with Sim-based Diagnostics for Robotic Simulation

**arXiv ID:** [2609.23103v1](https://arxiv.org/abs/2609.23103v1)

**作者:** Guanxiong Chen, Yiduo Qu, Qianjun Xia, Pengyu Jing, Yixian Cheng et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2609.23103v1.pdf)

---

## 5. Verti-WM: A Physics-Aided Exteroceptive World Model for Off-Road Reinforcement Learning

**arXiv ID:** [2609.23118v1](https://arxiv.org/abs/2609.23118v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2609.23118v1.pdf)

---

## 6. Information-Time Proximal Policy Optimization

**arXiv ID:** [2609.24380v1](https://arxiv.org/abs/2609.24380v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2609.24380v1.pdf)

---

## 7. Automatic multimodal UX improvement recommendations from LLM agent user simulations

**arXiv ID:** [2609.22971v1](https://arxiv.org/abs/2609.22971v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2609.22971v1.pdf)

---

## 8. VPRune: Efficient Training-free Pre-LLM Visual Token Pruning

**arXiv ID:** [2609.24485v1](https://arxiv.org/abs/2609.24485v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2609.24485v1.pdf)

---

## 9. Beyond Similarity: Coverage-Aware Prompt Selection for Time Series Forecasting with LLMs

**arXiv ID:** [2609.22977v1](https://arxiv.org/abs/2609.22977v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2609.22977v1.pdf)

---

## 10. CausalWM: Causal Chain-of-Thought Reasoning for Embodied World Model

**arXiv ID:** [2609.23184v1](https://arxiv.org/abs/2609.23184v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2609.23184v1.pdf)

---

## 11. UltraTex: Unleashing 2K Multi-View Diffusion for 3D Texturing

**arXiv ID:** [2609.23169v1](https://arxiv.org/abs/2609.23169v1)

**作者:** Yibo Zhang, Ze Yuan, Nan Cao, Li Zhang, Yan-Pei Cao et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2609.23169v1.pdf)

---

## 12. QwenVLConnector: A Fast, Unified Medical VLM Chatbot for Fine-Grained Clinical Perception and Text Generation

**arXiv ID:** [2609.23139v1](https://arxiv.org/abs/2609.23139v1)

**作者:** Le Thien Phuc Nguyen, Thien Nguyen, Thanh-Huy Nguyen, Gia Minh Hoang, Anh Mai Vu et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2609.23139v1.pdf)

---

## 13. Schedule optimization for tau-leaping in masked discrete diffusion
...
## 14. Directing large language models to follow the letter or spirit of the law

**arXiv ID:** [2609.23083v1](https://arxiv.org/abs/2609.23083v1)

**作者:** Peng Qian, Andrew Li, Sam Chen, Sonia K. Murthy, Yonatan Belinkov et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2609.23083v1.pdf)

---

## 15. LLM-Based FORM Code Generation with Verification-Driven Fine-Tuning

**arXiv ID:** [2609.23367v1](https://arxiv.org/abs/2609.23367v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2609.23367v1.pdf)
...
## 17. FoldQuantVLA: Native Low-Bit Quantization of Vision-Language-Action Models via Consistent Folding

**arXiv ID:** [2609.24433v1](https://arxiv.org/abs/2609.24433v1)

**作者:** Hung T. Ho, Khanh D. Nguyen, Quang D. Nguyen, Thanh Q. Duong, Ngan Le et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2609.24433v1.pdf)

---

## 18. Dissecting Agentic Forensics: The Role of Triage, Prompting, and Evidence Arbitration in Open-World Fake Image Detection

**arXiv ID:** [2609.24359v1](https://arxiv.org/abs/2609.24359v1)

**作者:** Xianlong Li, Pietro Bongini, Niccoló Pancino, Marco Blanchini, Benedetta Tondi et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2609.24359v1.pdf)

---

## 19. Robot World Models Are Not Invariant to How the Actions Are Written

**arXiv ID:** [2609.23252v1](https://arxiv.org/abs/2609.23252v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2609.23252v1.pdf)

---

## 20. Conduit: An Experience Data Plane for Distributed Reinforcement Learning

**arXiv ID:** [2609.24456v1](https://arxiv.org/abs/2609.24456v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2609.24456v1.pdf)

---

## 21. Judging a Review by its Cover: A Reliability Analysis of LLM-based Peer Review Evaluation Metrics

**arXiv ID:** [2609.23264v1](https://arxiv.org/abs/2609.23264v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2609.23264v1.pdf)
...
## 23. ActGov: Governing LLM Agent Actions via Policy-Constrained Validation

**arXiv ID:** [2609.24446v1](https://arxiv.org/abs/2609.24446v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2609.24446v1.pdf)

---

## 24. ARM: Attention with Routed-Memory for Learnable Sparse Control

**arXiv ID:** [2609.24417v1](https://arxiv.org/abs/2609.24417v1)

**作者:** Qiuhao Zeng, Jerry Huang, Peng Lu, Ruiyi Fang, Gezheng Xu et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2609.24417v1.pdf)

---

## 25. VLM-in-Sandbox: Visual Workspaces for Agentic Visual Reasoning

**arXiv ID:** [2609.24362v1](https://arxiv.org/abs/2609.24362v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2609.24362v1.pdf)

---

## 26. Enforcing Narrative Reliability and Epistemic Pacing in LLM-Driven Detective Games via Structured Knowledge Trees

**arXiv ID:** [2609.23043v1](https://arxiv.org/abs/2609.23043v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2609.23043v1.pdf)

---

## 27. The Right Future for Action: Learning Action-Relevant Predictive States in World Action Models

**arXiv ID:** [2609.23369v1](https://arxiv.org/abs/2609.23369v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2609.23369v1.pdf)

---

## 28. Steering Through Contact: A Finite-Support Motion Model for Single-Track Center-Articulated Robots

**arXiv ID:** [2609.23271v1](https://arxiv.org/abs/2609.23271v1)

**作者:** Mohamed Dhia Ounally, Nicolas Samson, Mathis Turgeon-Roy, Veronica Vannini, Johann Laconte et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2609.23271v1.pdf)
...
## 30. ProxyBuild: Text-Guided Structured 3D Building Generation with Mesh-Anchored Procedural Proxies

**arXiv ID:** [2609.23386v1](https://arxiv.org/abs/2609.23386v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2609.23386v1.pdf)

---

## 31. SPACE: Semantic Projection and Alignment of CLIP Embeddings for Domain Adaptation

**arXiv ID:** [2609.23248v1](https://arxiv.org/abs/2609.23248v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2609.23248v1.pdf)

---

## 32. VISTA: An Attention-Based Multi-Agent Reinforcement Learning Architecture for Space Situational Awareness Sensor Tasking
...
## 33. Decentralized Multi-Robot Exploration with Probabilistic Peer Intent and Multi-hop Plan Propagation

**arXiv ID:** [2609.22726v1](https://arxiv.org/abs/2609.22726v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2609.22726v1.pdf)

---

## 34. AutoGym: Blueprint-First Generation of Verifiable Agent Gyms

**arXiv ID:** [2609.22592v1](https://arxiv.org/abs/2609.22592v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2609.22592v1.pdf)

---

## 35. RLVR is a Kernel, Not a Function: Statistical Inference for pass@$k$ Crossovers

**arXiv ID:** [2609.22547v1](https://arxiv.org/abs/2609.22547v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2609.22547v1.pdf)

---

## 36. Fathom-Vaidya: Advancing Medical Reasoning with Rubric-Based Rewards

**arXiv ID:** [2609.24480v1](https://arxiv.org/abs/2609.24480v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2609.24480v1.pdf)

---

## 37. DeceptionAnalyser: A Web-Based AI Tool for Performing Structured Deception Analysis with Argumentation Schemes and LLMs

**arXiv ID:** [2609.24369v1](https://arxiv.org/abs/2609.24369v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2609.24369v1.pdf)

---

## 38. Co-occurrence Patterns of LoRA Adapters in Production Diffusion Model Inference Services

**arXiv ID:** [2609.23321v1](https://arxiv.org/abs/2609.23321v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2609.23321v1.pdf)

---

## 39. LLMs as Linguistic Chameleons: Decoupling Semantics and Structure for Privacy-Preserving Communication

**arXiv ID:** [2609.23193v1](https://arxiv.org/abs/2609.23193v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2609.23193v1.pdf)

---

## 40. MM-ContextFold: Context Folding for Multimodal Agentic Retrieval

**arXiv ID:** [2609.23121v1](https://arxiv.org/abs/2609.23121v1)

**作者:** Yang Tian, Fan Liu, Jingyuan Zhang, Zhenyang Li, Yupeng Hu et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2609.23121v1.pdf)

---

## 41. HDMamba-YOLO: Efficient State-Space Perception and Local Spatial Reconstruction for UAV Small Object

**arXiv ID:** [2609.23061v1](https://arxiv.org/abs/2609.23061v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2609.23061v1.pdf)

---

## 42. Manipulation Feasible Navigation Among Movable Obstacles with Discrete Contact Pushing

**arXiv ID:** [2609.23312v1](https://arxiv.org/abs/2609.23312v1)

**作者:** Shaohu Wang, Aiguo Song, Yulong Yuan, Zhongyu Sun, Tianyuan Miao et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2609.23312v1.pdf)

---

## 43. Fast and Robust Temporal Logic Planning via ADMM-based Trajectory Optimization

**arXiv ID:** [2609.23037v1](https://arxiv.org/abs/2609.23037v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2609.23037v1.pdf)

---

## 44. Adaptive Differential Evolution and Multistart Search for Noisy QAOA Optimization
...
## 45. Benchmarking Tabular Foundation Models as Surrogates in Expensive Evolutionary Optimization
...
## 47. Self-Organizing Agent Teams Learn to Reason Together

**arXiv ID:** [2609.22682v1](https://arxiv.org/abs/2609.22682v1)

**作者:** Aneesh Pappu, Mirac Suzgun, Yongchan Kwon, Federico Bianchi, Batu El et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2609.22682v1.pdf)

---

## 48. URA-NER: A Unified Retrieval-Augmented Framework with Retrieval Alignment and Uncertainty Reduction for Low-Resource NER

**arXiv ID:** [2609.24372v1](https://arxiv.org/abs/2609.24372v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2609.24372v1.pdf)

---

## 49. The Evidence Ladder for Reinforcement Learning in Healthcare: From Retrospective Policies to Trusted Interventions

**arXiv ID:** [2609.23374v1](https://arxiv.org/abs/2609.23374v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2609.23374v1.pdf)

---

## 50. CSC: Calibrated Simplicity for Conflict-Aware Social Bot Detection in the LLM Era

**arXiv ID:** [2609.23320v1](https://arxiv.org/abs/2609.23320v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2609.23320v1.pdf)

---

## 51. ValueDiff: Value-Geometric KV Cache Eviction for Sink-Suppressed LLMs

**arXiv ID:** [2609.23314v1](https://arxiv.org/abs/2609.23314v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2609.23314v1.pdf)

---

## 52. Vision-Wireless Fusion for Multi-User Localization: A Cross-Modal Transformer Approach

**arXiv ID:** [2609.23372v1](https://arxiv.org/abs/2609.23372v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2609.23372v1.pdf)

---

## 53. Connectivity-Aware Exploration of Robotic Grasp Spaces

**arXiv ID:** [2609.22983v1](https://arxiv.org/abs/2609.22983v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2609.22983v1.pdf)

---

## 54. A Confidence-Driven Evolutionary Algorithm for Noisy Optimization with Joint Chance Constraints
...
## 55. A Metaheuristic Optimization Framework for Discrete Optimization under Strict Time Limits
...
## 56. One to More, More to One: Category-Aware Iterative Expert Training for Software Engineering Agents

**arXiv ID:** [2609.23377v1](https://arxiv.org/abs/2609.23377v1)

**作者:** Jie Zhao, Ziyu Jiang, Suhang Zheng, Minghui Shan, Xiaoxiao Xu et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2609.23377v1.pdf)

---

## 57. Proximal Residual Value Functions for Consistent Planning and Real-Time Execution

**arXiv ID:** [2609.23242v1](https://arxiv.org/abs/2609.23242v1)

**作者:** Harrison Waldon, Carson Eisenach, Akhil Bagaria, Daniel Russo, Dominique Perrault-Joncas et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2609.23242v1.pdf)

---

## 58. From Concept Alignment to Causal Grounding: An Intervention Test of Chain-of-Thought Faithfulness

**arXiv ID:** [2609.23065v1](https://arxiv.org/abs/2609.23065v1)

**作者:** Qianli Wang, Yilong Wang, Dennis Wei, Jingyi Sun, Simon Ostermann et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2609.23065v1.pdf)

---

## 59. Attributable Post-Rationalization in RAG Citations: A Controlled Reproduction and an RLVR Comparison

**arXiv ID:** [2609.23053v1](https://arxiv.org/abs/2609.23053v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2609.23053v1.pdf)

---

## 60. MinCU: A Fine-Grained Benchmark for Grounded Minimal-Change Understanding in Image Pairs

**arXiv ID:** [2609.23336v1](https://arxiv.org/abs/2609.23336v1)

**作者:** Chaoqian Mu, Wenhao Wu, Zichen Liang, Jiaxu Li, Lijun Wang et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2609.23336v1.pdf)

---

## 61. VDGS: Visibility-Driven Large-Scale 3D Gaussian Splatting for Aerial Scene Reconstruction

**arXiv ID:** [2609.23049v1](https://arxiv.org/abs/2609.23049v1)

**作者:** Haolin Yu, Jiadong Tang, YiXian Wang, Yu Gao, Shi He et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2609.23049v1.pdf)

---

## 62. Tip Manipulation in Soft Everting Robots via Wall Retraction and Deployable Fingers

**arXiv ID:** [2609.23132v1](https://arxiv.org/abs/2609.23132v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2609.23132v1.pdf)

---

## 63. Artificial Neural Networks as Surrogate Models in Black Box Optimization
...
## 64. Bayesian Belief Layer for Controllable Opinion Dynamics in LLM Agents
...
## 65. Monotone-Constrained Diffusion Models for Long-Horizon Production Forecasting

**arXiv ID:** [2609.22643v1](https://arxiv.org/abs/2609.22643v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2609.22643v1.pdf)

---

## 66. Auditing Political Alignment in LLM Assistants: Engagement, Stance, and User Identity

**arXiv ID:** [2609.23039v1](https://arxiv.org/abs/2609.23039v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2609.23039v1.pdf)

---

## 67. The evolution of sex for artificial intelligence: a population-genetic framework for multigenerational model populations
...
## 68. Conflicting Pattern Formation by Teams of Anonymous, Fully Disoriented Robots
...
## 69. Personalized Federated Reinforcement Learning via Model-Agnostic Meta-Learning: Convergence of Exact and Hessian-Free Meta-Policy Gradients

**arXiv ID:** [2609.22833v1](https://arxiv.org/abs/2609.22833v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2609.22833v1.pdf)

---

## 70. Single-Loop Stochastic Projected Damped Extragradient Methods for Stochastic Nonconvex--(Strongly) Concave Minimax Optimization
...
## 71. Do LiDAR Language Models Really Understand Spatio-temporal Relationships?

**arXiv ID:** [2609.24452v1](https://arxiv.org/abs/2609.24452v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2609.24452v1.pdf)

---

## 72. Estimating Accurate Hand Pose in Camera Space with Vision Transformer

**arXiv ID:** [2609.24424v1](https://arxiv.org/abs/2609.24424v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2609.24424v1.pdf)

---

## 73. Tactile-JEPA: Topology-Aware Self-Supervised Representation Learning for Distributed Tactile Sensors

**arXiv ID:** [2609.24385v1](https://arxiv.org/abs/2609.24385v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2609.24385v1.pdf)

---

## 74. Knowing When to Trust Images: Reliability-Aware Multi-modal Entity Alignment

**arXiv ID:** [2609.23267v1](https://arxiv.org/abs/2609.23267v1)

**作者:** Chenxiao Li, Yunhe Feng, Dongfang Liu, Dong Nie, Yan Huang et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2609.23267v1.pdf)

---

## 75. BiView-Touch: Learning Bimanual Tactile Representations by Cross-Hand Completion

**arXiv ID:** [2609.23352v1](https://arxiv.org/abs/2609.23352v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2609.23352v1.pdf)

---

## 76. AniPrO: Interpretable Anime Image Provenance Detection via Multi-Dimensional Semantic Reasoning

**arXiv ID:** [2609.23345v1](https://arxiv.org/abs/2609.23345v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2609.23345v1.pdf)

---

## 77. Shared Execution-Clock Drifting Policy for Dynamic Precision Manipulation

**arXiv ID:** [2609.23305v1](https://arxiv.org/abs/2609.23305v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2609.23305v1.pdf)

---

## 78. SCULPT-VLA: Learning Structured Control through Staged Action Grounding

**arXiv ID:** [2609.23275v1](https://arxiv.org/abs/2609.23275v1)

**作者:** Wenbo Li, Yiteng Chen, Wei Zhang, Wenhao Li, Jun Yang et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2609.23275v1.pdf)

---

## 79. Task aware Dynamic Movement Primitives for failure detection and recovery in contact rich manipulation

**arXiv ID:** [2609.23151v1](https://arxiv.org/abs/2609.23151v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2609.23151v1.pdf)

---

## 80. Probabilistic Scene Graphs: Hierarchical Representation and Real-time System

**arXiv ID:** [2609.23144v1](https://arxiv.org/abs/2609.23144v1)

**作者:** Waqas Ali, Michele Antonazzi, Timon Homberger, Thien-Minh Nguyen, Lukas Rosenberger Schmid et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2609.23144v1.pdf)

---

## 81. AquaCap: A Training-Free Underwater Embodied Agent with Code-as-Policy

**arXiv ID:** [2609.23133v1](https://arxiv.org/abs/2609.23133v1)

**作者:** Xiaoshi Li, Yule Xu, Chunghiu Kong, Yizhou Zhou, Yang Liu et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2609.23133v1.pdf)

---

## 82. Event-based Selective Attention for Multi-resolution Fast Region of Interest (ROI) Detection
...
## 83. Density-Driven Area Coverage for Nonholonomic Multi-Robot Systems with Safety Guarantee

**arXiv ID:** [2609.22668v1](https://arxiv.org/abs/2609.22668v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2609.22668v1.pdf)

---

## 84. A Patient World Model for Early Forecasting of Digital Health Campaign Outcomes: Capabilities and Limits

**arXiv ID:** [2609.23333v1](https://arxiv.org/abs/2609.23333v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2609.23333v1.pdf)

---

## 85. Emergent Intelligence: Resonant Oscillators Produce Proactive Adaptive Behavior
...
## 86. A Task-Oriented Multi-Agent Framework for Complex Wearable Health Analysis
...
## 87. From Certain Doom to Survival: Agent-Driven Self-Governance in LLM Agent Societies

**arXiv ID:** [2609.22600v1](https://arxiv.org/abs/2609.22600v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2609.22600v1.pdf)

---

## 88. Locally Private Inference for Riemannian Stochastic Optimization

**arXiv ID:** [2609.22642v1](https://arxiv.org/abs/2609.22642v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2609.22642v1.pdf)

---

## 89. Beyond Predictable Paths: Redefining AI Security Incident Reporting for Agents

**arXiv ID:** [2609.24515v1](https://arxiv.org/abs/2609.24515v1)

**作者:** Anastasia Pustozerova, Eugene Bagdasarian, Luca Beurer-Kellner, Battista Biggio, Nico Ebert et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2609.24515v1.pdf)

---

## 90. Predicting Postprandial Glycemic Response from Meal Images, Clinical Variables, and Gut Microbiome Information

**arXiv ID:** [2609.24453v1](https://arxiv.org/abs/2609.24453v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2609.24453v1.pdf)

---

## 91. WPBench: A Comprehensive Benchmark for Wind Power Forecasting

**arXiv ID:** [2609.24444v1](https://arxiv.org/abs/2609.24444v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2609.24444v1.pdf)

---

## 92. Why Ghost Outputs Teach: A Kernel-Based Understanding of Subliminal Learning

**arXiv ID:** [2609.23260v1](https://arxiv.org/abs/2609.23260v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2609.23260v1.pdf)

---

## 93. SoK: Formal Methods for Fact-Checking and Information Integrity

**arXiv ID:** [2609.23239v1](https://arxiv.org/abs/2609.23239v1)

**作者:** Nikolaos Kekatos, Theodoros Nestoridis, Charalampos Bratsas, Charalampos Dimoulas, Georgios Konstantinidis et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2609.23239v1.pdf)

---

## 94. ChemCLIR-Bench: Benchmarking Cross-Lingual Information Retrieval in Multilingual Chemical Patents

**arXiv ID:** [2609.23231v1](https://arxiv.org/abs/2609.23231v1)

**作者:** Mahdi Astaraki, Mohammad Khodadad, Reza Namazi, Mohammad Arshi Saloot, Amir Reza Behzad Moghadam et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2609.23231v1.pdf)

---

## 95. Chronologic: Measuring Language Models' Ability to Represent the Past

**arXiv ID:** [2609.23178v1](https://arxiv.org/abs/2609.23178v1)

**作者:** Ted Underwood, Ziliang Qiu, Sarah Griebel, Laura K. Nelson, Edwin Roland et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2609.23178v1.pdf)

---

## 96. OmniEdu: Open Foundation Models for Learning and Teaching

**arXiv ID:** [2609.23088v1](https://arxiv.org/abs/2609.23088v1)

**作者:** Hao Liang, Qihan Lin, Meiyi Qiang, Linzhuang Sun, Hengyi Feng et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2609.23088v1.pdf)

---

## 97. AgentRouter: Heterogeneous Model Routing for Cost-Optimal Multi-Step Agentic Workflows
...
## 98. LiteTex-GS: Fast and Lightweight Texturing for Gaussian Splatting

**arXiv ID:** [2609.23380v1](https://arxiv.org/abs/2609.23380v1)

**作者:** Zhiwei Li, Yijia Guo, Yishi Lu, Liwen Hu, Hong Rao et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2609.23380v1.pdf)

---

## 99. GrapeSplat: Geometry-Grounded Reconstruction via Amalgamated Pose-Free Encoding for Feed-Forward 3D Gaussian Splatting

**arXiv ID:** [2609.23182v1](https://arxiv.org/abs/2609.23182v1)

**作者:** Si-Yu Lu, Yung-Yao Chen, Yi Jan Chen, Shang-Lin Li, Ching-Chan Liao et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2609.23182v1.pdf)

---

## 100. LD-RSVIS: A Large-Scale and Diverse Benchmark for Referring Surgical Video Instrument Segmentation

**arXiv ID:** [2609.23067v1](https://arxiv.org/abs/2609.23067v1)

**作者:** Zan Wang, Yunhe Feng, Dong Nie, Oluwatosin Oluwadare, Kewei Sha et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2609.23067v1.pdf)

---

## 101. Predictive Suppression Layers for Communication-Efficient Spiking Neural Networks
...
## 102. Graph neural networks for exoplanet atmospheres
...
## 103. Neuro-Symbolic Hierarchical Intention Anticipation in Human Behavior
...
## 104. TRACS: A Geometry-Aware Framework for Scalable Multi-Agent Path Finding in Warehouses
...
## 105. A Bayesian Vertical Federated Learning Framework for Multivariate Reduced-Rank High-Dimensional Regression

**arXiv ID:** [2609.22654v1](https://arxiv.org/abs/2609.22654v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2609.22654v1.pdf)

---

## 106. Tutoring Large Language Models to be Domain-adaptive, Precise and Safe

**arXiv ID:** [2609.23071v1](https://arxiv.org/abs/2609.23071v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2609.23071v1.pdf)

---

## 107. Artificial Structure Function Search: Preserving Artificial Functional Connectivity for Structured Pruning

**arXiv ID:** [2609.24401v1](https://arxiv.org/abs/2609.24401v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2609.24401v1.pdf)

---

## 108. Mitigating Entity Type Confusion in Cross-Domain NER via Multidimensional Quantification and Reasoning Enhancement

**arXiv ID:** [2609.24357v1](https://arxiv.org/abs/2609.24357v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2609.24357v1.pdf)

---

## 109. Optimal Multi-way Decision Trees for Stratified Sampling in Online Controlled Experiments

**arXiv ID:** [2609.23308v1](https://arxiv.org/abs/2609.23308v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2609.23308v1.pdf)

---

## 110. Stochastic Flow Map for Count Data

**arXiv ID:** [2609.23290v1](https://arxiv.org/abs/2609.23290v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2609.23290v1.pdf)

---

## 111. Low resource cross-modal alignment using HGNN to enhance speech representation

**arXiv ID:** [2609.23191v1](https://arxiv.org/abs/2609.23191v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2609.23191v1.pdf)

---

## 112. Blind Deconvolution of Binary and Pattern Images with Pixel Intensity Constraints and Sparse Gradient Prior

**arXiv ID:** [2609.23268v1](https://arxiv.org/abs/2609.23268v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2609.23268v1.pdf)

---

## 113. Selective Commitment for Language-Guided Object Retrieval under Partial Observability

**arXiv ID:** [2609.23131v1](https://arxiv.org/abs/2609.23131v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2609.23131v1.pdf)

---

## 114. Self-Replicating Neural Cellular Automata: Quantifying Emergent Phenotypic and Genotypic Diversity in an OpenEnded Substrate
...
## 115. Mixed-integer flow formulations for motion planning and decision-making of networked multi-agent systems
...
## 116. CityLearn v3: A Configurable Simulation and Evaluation Framework for Realistic Control Studies of Renewable Energy Communities
...
## 117. EnterpriseVal: Quantifying the Efficacy, Reliability and Value of Generative AI in the Enterprise
...
## 118. Multi-Domain Clustering via Measure Quantization
...
## 119. AgentSTAR: Agentic Shape Tracking and Reconstruction from Monocular Videos

**arXiv ID:** [2609.24487v1](https://arxiv.org/abs/2609.24487v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2609.24487v1.pdf)

---

## 120. Bayesian Filtering in Physical Systems via Test-time Trained Flow Matching

**arXiv ID:** [2609.23383v1](https://arxiv.org/abs/2609.23383v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2609.23383v1.pdf)

---

## 121. Machine-Interpretable Information: Compiling Documents into Searchable and Readable Protocol States

**arXiv ID:** [2609.23371v1](https://arxiv.org/abs/2609.23371v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2609.23371v1.pdf)

---

## 122. Bridging Static and Agentic RAG for Taiwanese Historical Question Answering

**arXiv ID:** [2609.23056v1](https://arxiv.org/abs/2609.23056v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2609.23056v1.pdf)

---

## 123. RegVGGT: Sustainable Visual Geometry Grounding for Streaming via Regulated Memory

**arXiv ID:** [2609.23286v1](https://arxiv.org/abs/2609.23286v1)

**作者:** Hongbo Mao, Junjun Jiang, Youyu Chen, Jiaxin Zhang, Zhemeng Dong et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2609.23286v1.pdf)

---

## 124. BrainIAC: Interactive 3D Brain Lesion Segmentation across Heterogeneous MRI Modalities with Online Adaptation

**arXiv ID:** [2609.23026v1](https://arxiv.org/abs/2609.23026v1)

**作者:** Wentian Xu, Anthony P Addison, Ziyun Liang, Harry Anthony, Guang Yang et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2609.23026v1.pdf)

---

## 125. SomaNet: Weakly Supervised Learning for Instance Soma Segmentation in 3D Electron Microscopy with Partial Annotations

**arXiv ID:** [2609.23019v1](https://arxiv.org/abs/2609.23019v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2609.23019v1.pdf)

---

## 126. Safety-Critical Control under Uncertainty via Adaptive Conformal Quantile Prediction Intervals

**arXiv ID:** [2609.23280v1](https://arxiv.org/abs/2609.23280v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2609.23280v1.pdf)

---

## 127. Scenario MPC with STL Specifications and Pareto-Based Feasibility Repair

**arXiv ID:** [2609.23263v1](https://arxiv.org/abs/2609.23263v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2609.23263v1.pdf)

---

## 128. Orientation-Aware Control and Trajectory Design for Aerial RIS-Assisted Wireless Communications

**arXiv ID:** [2609.23157v1](https://arxiv.org/abs/2609.23157v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2609.23157v1.pdf)

---

## 129. Sensing to Intelligence: Principles for Neuromorphic Circuits and Systems
...
## 130. Bio-Inspired Palette Evolution in Indirectly Encoded Substrates: Timescale Compatibility Shapes Activation Function Discovery
...
## 131. Testing, not presuming, adequacy: calibrating generative social simulators against emergent network structure

**arXiv ID:** [2609.24012v1](https://arxiv.org/abs/2609.24012v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2609.24012v1.pdf)

---

## 132. NostrAgent: A Decentralized Identity and Delegation Architecture for Sovereign Agentic Systems

**arXiv ID:** [2609.22944v1](https://arxiv.org/abs/2609.22944v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2609.22944v1.pdf)

---

## 133. Bayesian Deck-of-cards-based Ordinal Regression with Sequential Preference Elicitation

**arXiv ID:** [2609.23212v1](https://arxiv.org/abs/2609.23212v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2609.23212v1.pdf)

---

## 134. Subspace Learning with Interval-Censored Likelihoods for Dequantizing Percept PC LFP Snapshots

**arXiv ID:** [2609.22658v1](https://arxiv.org/abs/2609.22658v1)

**作者:** Shreesh Karjagi, Elif Ceren Fitoz, Maryam Khalid, Tanya Nauvel, Parisa Sarikhani et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2609.22658v1.pdf)

---

## 135. Adaptive Scaffolding Needs Contingency: An AI Tutor That Escalates and Fades on What the Learner Does
...
## 136. On the Control of Mobile Ad-Hoc Agent Deployments in Partially Observed Space

**arXiv ID:** [2609.23060v1](https://arxiv.org/abs/2609.23060v1)

**作者:** Edwin Meriaux, Louis-Roy Langevin, Shuo Wen, Ndiamé Ndiaye, Gregory Dudek et al.
...
**PDF:** [下载](http://arxiv.org/pdf/2609.23060v1.pdf)

---

## 137. If You Hear It, Help Find It: Orthogonal Knowledge Distillation for Open-Vocabulary Audio-Visual Event Localization

**arXiv ID:** [2609.23376v1](https://arxiv.org/abs/2609.23376v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2609.23376v1.pdf)

---

## 138. Euston: Training Away Mathematical Sycophancy Without Losing the Mathematics

**arXiv ID:** [2609.23205v1](https://arxiv.org/abs/2609.23205v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2609.23205v1.pdf)

---

## 139. Enhancing speech representation learning with cross-modal knowledge transfer with HGNN under low resource settings: the case study of Yemba

**arXiv ID:** [2609.23194v1](https://arxiv.org/abs/2609.23194v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2609.23194v1.pdf)

---

## 140. Rethinking Pivot Programming Languages in Code Language Models

**arXiv ID:** [2609.22988v1](https://arxiv.org/abs/2609.22988v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2609.22988v1.pdf)

---

## 141. Identity Continuity in Long-Term Embodied AI Relationships: From Agent-Specific Identity Representation to Identity-Continuity Appraisal

**arXiv ID:** [2609.23356v1](https://arxiv.org/abs/2609.23356v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2609.23356v1.pdf)

---

## 142. Splat-CBF: Safe Next-Best-View Control in 3D Gaussian-Splat Maps

**arXiv ID:** [2609.23100v1](https://arxiv.org/abs/2609.23100v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2609.23100v1.pdf)

---

## 143. M3GA-Wild: A Large-Scale Dataset and Benchmark for Multi-Modal Multi-session Ground-to-Aerial Place Recognition in Forests

**arXiv ID:** [2609.23003v1](https://arxiv.org/abs/2609.23003v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2609.23003v1.pdf)

---

## 144. DCL-GPGLS: Dynamic Curriculum Learning for Genetic Programming Guided Local Search in Large-Scale Vehicle Routing
...
## 145. Genetic Programming with Behaviour-based Niching for Learning Guided Local Search in Vehicle Routing Problems
...
## 146. Neural noise enables accurate internal simulation of rare events
...
## 147. Conformal Robustness in Prediction-Driven Decision-Making

**arXiv ID:** [2609.23170v1](https://arxiv.org/abs/2609.23170v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2609.23170v1.pdf)

---

## 148. Geometric Mean Pooling for Equal-Weight Multiplicative Coarse-Graining
...
## 149. Classification with Abstention Under Class-Conditional Error Constraints

**arXiv ID:** [2609.22632v1](https://arxiv.org/abs/2609.22632v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2609.22632v1.pdf)

---

## 150. Blind Thermodynamic Ontology Discovery from Anonymous Experiments

**arXiv ID:** [2609.23387v1](https://arxiv.org/abs/2609.23387v1)
...
**PDF:** [下载](http://arxiv.org/pdf/2609.23387v1.pdf)
